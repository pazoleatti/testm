 ...
 */
public class PrimaryRnuNdflCheckScriptTest extends DeclarationScriptTestBase {

    public PrimaryRnuNdflCheckScriptTest() {
        super();
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(PrimaryRnuNdflCheckScriptTest.class);
    }
...
// и «графа 10 Раздел 3»= «графа 6 Раздел 2», то «графа 12 Раздел 2» = сумма значений «граф 16 Раздел 3» при соблюдении обязательного условия: «сумма значений «граф 16 Раздела 3» ≤ «графа 10 Раздел 2»
    ...
    private static class NdflPersonBuilder {
        ...
        public static class Builder {
            ...
            public NdflPerson build() {
                return new PrimaryRnuNdflCheckScriptTest.NdflPersonBuilder(this).ndflPerson;
            }
        }
    ...
    private static class NdflPersonIncomeBuilder {
        ...
        public static class Builder {
            ...
            public NdflPersonIncome build() {
                return new PrimaryRnuNdflCheckScriptTest.NdflPersonIncomeBuilder(this).ndflPersonIncome;
            }
        }
    ...
    private static class NdflPersonDeductionBuilder {
        ...
        public static class Builder {
            ...
            public NdflPersonDeduction build() {
                return new PrimaryRnuNdflCheckScriptTest.NdflPersonDeductionBuilder(this).ndflPersonDeduction;
            }
    ...
    private static class RefBookPersonTestBuilder {
        ...
        public static class Builder {
            ...
            public RefBookPersonTest build() {
                return new PrimaryRnuNdflCheckScriptTest.RefBookPersonTestBuilder(this).refBookPersonTest;
            }
        }
    ...
    private static class RefBookAddressTestBuilder {
        ...
        public static class Builder {
            ...
            public Builder appartment(String appartment) {
                this.appartment = appartment;
                return this;
            }

            public RefBookAddressTest build() {
                return new PrimaryRnuNdflCheckScriptTest.RefBookAddressTestBuilder(this).refBookAddressTest;
            }
        }
