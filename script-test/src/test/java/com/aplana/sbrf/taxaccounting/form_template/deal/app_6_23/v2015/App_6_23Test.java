package com.aplana.sbrf.taxaccounting.form_template.deal.app_6_23.v2015;
 ...
 * @author Emamedova
 */
public class App_6_23Test extends ScriptTestBase {
    private static final int TYPE_ID = 832;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(App_6_23Test.class);
    }
    ...
    public void check1Test() throws ParseException {
        ...
        formData.initFormTemplateParams(testHelper.getTemplate("..//src/main//resources//form_template//deal//app_6_23//v2015//"));
        ...
        row.getCell("serviceType").setValue("1", null);
        ...
        Assert.assertEquals("Строка 1: Дата, указанная в графе «Дата договора» должна принимать значение из следующего диапазона: 01.01.1991 - 31.12.2014!", entries.get(i++).getMessage());
