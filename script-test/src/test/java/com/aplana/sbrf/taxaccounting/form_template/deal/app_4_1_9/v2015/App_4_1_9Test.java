...
public class App_4_1_9Test extends ScriptTestBase {
    ...
    public void check1Test() throws ParseException {
        ...
        String [] nonEmptyColumns = { "name", "sum4", "sum42", "sum43", "sum44", "sum45", "sum46", "sum51", "sum52", "sum53", "sum54",
    ...
    void checkData(List<DataRow<Cell>> dataRows) {
        ...
        // графа 4  (4.1)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum4").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum4").getNumericValue().longValue());
        // графа 5  (4.2)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum42").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum42").getNumericValue().longValue());
        // графа 6  (4.3)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum43").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum43").getNumericValue().longValue());
        // графа 7  (4.4)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum44").getNumericValue().longValue());
        Assert.assertEquals(100100L, dataRows.get(1).getCell("sum44").getNumericValue().longValue());
        // графа 8  (4.5)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum45").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum45").getNumericValue().longValue());
        // графа 9  (4.6)
        ...
        // графа 10 (5.1)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum51").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum51").getNumericValue().longValue());
        // графа 11 (5.2)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum52").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum52").getNumericValue().longValue());
        // графа 12 (5.3)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum53").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum53").getNumericValue().longValue());
        // графа 13 (5.4)
        ...
        // графа 14 (5.5)
        Assert.assertEquals(0L, dataRows.get(0).getCell("sum55").getNumericValue().longValue());
        Assert.assertEquals(0L, dataRows.get(1).getCell("sum55").getNumericValue().longValue());
        // графа 15 (5.6)
        ...
        for (String alias : calc17Aliases) {
            expected16 += dataRows.get(1).getCell(alias).getNumericValue().longValue();
        }
        ...
        // графа 18 (8)
        long expected18 = expected16 * 4 / 3;
        ...
        // графа 21 (11)
        Assert.assertEquals(183L, dataRows.get(0).getCell("categoryPrimary").getNumericValue().longValue());
        Assert.assertEquals(3L, dataRows.get(1).getCell("categoryPrimary").getNumericValue().longValue());
    }
