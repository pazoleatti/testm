 ...
 */
public class DeclarationTypeScriptTest extends RefBookScriptTestBase {

    @Override
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(DeclarationTypeScriptTest.class);
    }
    ...
    public void testNdfl2Prot() throws ParseException {
        ...
        InputStream inputStream = DeclarationTypeScriptTest.class.getResourceAsStream("/com/aplana/sbrf/taxaccounting/refbook/declaration_type/" + fileName);
    ...
    public void testNdfl6IV() throws ParseException {
        ...
        testHelper.setImportInputStream(inputStream);
        testHelper.setUploadFileName(fileName);
        testHelper.setDataFile(new File(DeclarationTypeScriptTest.class.getResource("/com/aplana/sbrf/taxaccounting/refbook/declaration_type/" + fileName).getPath()));
