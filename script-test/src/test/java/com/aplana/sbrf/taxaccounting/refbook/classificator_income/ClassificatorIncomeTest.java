package com.aplana.sbrf.taxaccounting.refbook.classificator_income;
...
/**
 * «Классификатор доходов Сбербанка России для целей налогового учёта» (id = 28)
 *
 * @author Emamedova
 */
public class ClassificatorIncomeTest extends RefBookScriptTestBase {

    @Override
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(ClassificatorIncomeTest.class);
    }
