...
public class Ndfl62Test extends RefBookScriptTestBase {
    ...
    public void initMock() {
        Mockito.reset(testHelper.getDeclarationService());
    }
    ...
    public void testNdfl2Prot() throws ParseException {
        ...
        when(testHelper.getDeclarationService().findDeclarationDataByFileNameAndFileType(anyString(), anyLong()))
                .thenReturn(declarationData);
