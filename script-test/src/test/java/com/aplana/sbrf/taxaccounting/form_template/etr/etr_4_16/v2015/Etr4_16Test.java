package com.aplana.sbrf.taxaccounting.form_template.etr.etr_4_16.v2015;
 ...
 */
public class Etr4_16Test extends ScriptTestBase {
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Etr4_16Test.class);
    }
    ...
    void checkLoadData(List<DataRow<Cell>> dataRows) {
        Assert.assertEquals(10, dataRows.get(0).getCell("comparePeriod").getNumericValue().intValue());
        Assert.assertEquals(100, dataRows.get(1).getCell("comparePeriod").getNumericValue().intValue());
        Assert.assertEquals(90, dataRows.get(2).getCell("comparePeriod").getNumericValue().intValue());
        Assert.assertEquals(18, dataRows.get(3).getCell("comparePeriod").getNumericValue().intValue());

        Assert.assertEquals(10, dataRows.get(0).getCell("currentPeriod").getNumericValue().intValue());
        Assert.assertEquals(100, dataRows.get(1).getCell("currentPeriod").getNumericValue().intValue());
        Assert.assertEquals(90, dataRows.get(2).getCell("currentPeriod").getNumericValue().intValue());
        Assert.assertEquals(18, dataRows.get(3).getCell("currentPeriod").getNumericValue().intValue());
