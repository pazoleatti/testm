...
public class ForwardContractsTest extends DealBaseTest {
    ...
    public void check1Test() throws ParseException {
        ...
        formData.initFormTemplateParams(testHelper.getTemplate("..//src/main//resources//form_template//deal//forward_contracts//v2015//"));
        ...
        row.getCell("dealType").setValue("dealType", null);
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(650333, dataRows.get(3).getCell("price").getNumericValue().intValue());
        Assert.assertEquals(250000, dataRows.get(0).getCell("price").getNumericValue().intValue());
        Assert.assertEquals(1, dataRows.get(1).getCell("price").getNumericValue().intValue());

        Assert.assertEquals(25000, dataRows.get(2).getCell("total").getNumericValue().intValue());
        Assert.assertEquals(650333, dataRows.get(3).getCell("total").getNumericValue().intValue());
        Assert.assertEquals(250000, dataRows.get(0).getCell("total").getNumericValue().intValue());
        Assert.assertEquals(1, dataRows.get(1).getCell("total").getNumericValue().intValue());
    }
