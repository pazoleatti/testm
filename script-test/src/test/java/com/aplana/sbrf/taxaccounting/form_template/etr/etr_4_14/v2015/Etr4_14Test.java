package com.aplana.sbrf.taxaccounting.form_template.etr.etr_4_14.v2015;
...
public class Etr4_14Test extends ScriptTestBase {
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Etr4_14Test.class);
    }
    ...
    void checkLoadData(List<DataRow<Cell>> dataRows) {
        // графа 4..9 - для всех строк, кроме строки I
        String [] calcColumns = { "comparePeriod", "comparePeriodPercent", "currentPeriod", "currentPeriodPercent", "deltaRub", "deltaPercent" };
        // графа 4, 6, 8, 9 - для строк I
        String [] calcColumns1 = { "comparePeriod", "currentPeriod", "deltaRub", "deltaPercent" };
        Long expected = 0L;
        for (DataRow<Cell> row : dataRows) {
            ...
            expected++;
            String [] columns = ("I".equals(row.getAlias()) ? calcColumns1 : calcColumns);
    ...
    void checkConsolidatedData(List<DataRow<Cell>> dataRows) {
        // графа 4, 6 - для всех строк, кроме строки I
        String [] consolidatedColumns = { "comparePeriod", "currentPeriod" };
        // графа 4..9 - для всех строк, кроме строк I
        String [] calcColumns = { "comparePeriod", "comparePeriodPercent", "currentPeriod", "currentPeriodPercent", "deltaRub", "deltaPercent" };
        // графа 4, 6, 8, 9 - для строк I
        String [] calcColumns1 = { "comparePeriod", "currentPeriod", "deltaRub", "deltaPercent" };
        Long expected = 0L;
