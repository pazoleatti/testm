...
public class App_6_15Test extends ScriptTestBase {
    private static final int TYPE_ID = 837;
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Внутренний код"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Код страны происхождения предмета сделки"), entries.get(i++).getMessage());
