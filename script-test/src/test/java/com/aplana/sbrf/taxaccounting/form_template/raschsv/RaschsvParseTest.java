...
public class RaschsvParseTest extends ScriptTestBase {
    ...
    public void create() throws IOException {
        ...
        InputStream xmlInputStream = MapXmlToTableTest.class.getResourceAsStream("/com/aplana/sbrf/taxaccounting/form_template/raschsv/raschsv.xml");
        ...
        testHelper.execute(FormDataEvent.IMPORT, param);
