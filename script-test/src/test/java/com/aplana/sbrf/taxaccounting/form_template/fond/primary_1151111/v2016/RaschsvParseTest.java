...
public class RaschsvParseTest extends ScriptTestBase {
    ...
    public void checkRaschsvInvalid() {
        ...
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПерОПС.КБК = \"10302330010000111\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПерОПС.КБК = \"10302330010000112\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПерОМС.КБК = \"10302330010000113\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПерОПСДоп.КБК = \"10302330010000114\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПерДСО.КБК = \"10302330010000115\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ОбязПлатСВ.УплПревОСС.КБК = \"10302330010000116\" не найден в справочнике \"Классификатор кодов классификации доходов бюджетов Российской Федерации\""));
        ...
        Assert.assertTrue(containLog("Некорректный Файл.Документ.РасчетСВ.ОбязПлатСВ.СВПримТариф2.2.425.СвИноГражд.ИННФЛ = \"500100732250\" иностранного гражданина в транспортном файле \"" + FILE_NAME + "\""));
        Assert.assertTrue(containLog("Некорректный Файл.Документ.РасчетСВ.ОбязПлатСВ.СВПримТариф2.2.425.СвИноГражд.СНИЛС = \"112-233-445 90\" иностранного гражданина в транспортном файле \"" + FILE_NAME + "\""));
        ...
        Assert.assertTrue(containLog("Файл.Документ.РасчетСВ.ПерсСвСтрахЛиц.ДанФЛПолуч.СерНомДок = \"№123 321\" не соответствует порядку заполнения: знак \"N\" не проставляется, серия и номер документа отделяются знаком \" \" (\"пробел\")"));
    }
