package com.aplana.sbrf.taxaccounting.form_template.etr.etr_4_5.v2015;
...
/**
 * Приложение 4-4. Отношение налогов, относимых на расходы к операционным расходам.
 */
public class Etr4_5Test extends ScriptTestBase {
    private static final int TYPE_ID = 705;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Etr4_5Test.class);
    }
