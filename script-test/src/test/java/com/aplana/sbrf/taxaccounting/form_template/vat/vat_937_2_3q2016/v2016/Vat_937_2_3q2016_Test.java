package com.aplana.sbrf.taxaccounting.form_template.vat.vat_937_2_3q2016.v2016;
 ...
 */
public class Vat_937_2_3q2016_Test extends ScriptTestBase {
    private static final int TYPE_ID = 857;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Vat_937_2_3q2016_Test.class);
    }
    ...
    void checkLoadData(List<DataRow<Cell>> dataRows) {
        ...
        for (DataRow<Cell> row : dataRows) {
            ...
            // графа 2
            Assert.assertNotNull("row.opTypeCode[" + row.getIndex() + "]", row.getCell("opTypeCode").getValue());
