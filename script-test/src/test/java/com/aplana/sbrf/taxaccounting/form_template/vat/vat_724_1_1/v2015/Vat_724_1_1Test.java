...
public class Vat_724_1_1Test extends ScriptTestBase {
    ...
    public void check2Test() {
        ...
        int i = 0;
        Assert.assertEquals("Строка 5: Должна быть заполнена хотя бы одна из граф с суммой корректировки (+, -) налоговой базы (раздел 1-6)!", entries.get(i++).getMessage());
        ...
        Assert.assertEquals("Строка 8: Графа с суммой корректировки (+) налоговой базы (раздел 1-6) должна быть заполнена значением больше «0»!", entries.get(i++).getMessage());
        Assert.assertEquals("Строка 8: Графа с суммой корректировки (-) налоговой базы (раздел 1-6) должна быть заполнена значением меньше «0»!", entries.get(i++).getMessage());
        ...
        Assert.assertEquals("Строка 13: Графы с суммой корректировки (+, -) налоговой базы (раздел 7-9) не должны быть заполнены!", entries.get(i++).getMessage());
