...
public class Rnu_116Test extends ScriptTestBase {
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals("Строка 1: Графа «Дата исполнения сделки» не заполнена!", entries.get(i++).getMessage());
        ...
        Assert.assertEquals("Строка 1: Графа «Код валюты по сделке приобретения (требования)» не заполнена!", entries.get(i++).getMessage());
        Assert.assertEquals("Строка 1: Графа «Объем покупаемой валюты» не заполнена!", entries.get(i++).getMessage());
        Assert.assertEquals("Строка 1: Графа «Код валюты по сделке продажи (обязательства)» не заполнена!", entries.get(i++).getMessage());
        Assert.assertEquals("Строка 1: Графа «Объем продаваемой валюты» не заполнена!", entries.get(i++).getMessage());
        Assert.assertEquals("Строка 1: Графа «Курс сделки» не заполнена!", entries.get(i++).getMessage());
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(-1, dataRows.get(0).getCell("outcomeSum").getNumericValue().doubleValue(), 0);
    }
}
