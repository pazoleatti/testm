package com.aplana.sbrf.taxaccounting.form_template.income.rnu4.v2016;
...
public class Rnu4Test extends ScriptTestBase {
    ...
    public void importExcelTest() {
        ...
        Assert.assertEquals(300, dataRows.get(2).getCell("sum").getNumericValue().intValue());
        Assert.assertEquals(500, dataRows.get(3).getCell("sum").getNumericValue().intValue());
    ...
    void checkLoadData(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(2, dataRows.get(2).getCell("balance").getNumericValue().intValue());
