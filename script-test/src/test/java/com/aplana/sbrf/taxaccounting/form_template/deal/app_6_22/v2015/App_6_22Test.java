package com.aplana.sbrf.taxaccounting.form_template.deal.app_6_22.v2015;
 ...
 * 6_22
 */
public class App_6_22Test extends ScriptTestBase {
    private static final int TYPE_ID = 834;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(App_6_22Test.class);
    }
    ...
    public void check1Test() throws ParseException {
        ...
        formData.initFormTemplateParams(testHelper.getTemplate("..//src/main//resources//form_template//deal//app_6_22//v2015//"));
        ...
        Assert.assertEquals(String.format(ScriptUtils.CHECK_DATE_PERIOD_EXT, 1, "Дата совершения сделки", "01.01.2014", "31.12.2014", "Дата сделки"), entries.get(i++).getMessage());
        Assert.assertEquals(i, testHelper.getLogger().getEntries().size());
        testHelper.getLogger().clear();
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(3, dataRows.get(2).getCell("price").getNumericValue().doubleValue(), 0);
        ...
        Assert.assertEquals(3, dataRows.get(2).getCell("cost").getNumericValue().doubleValue(), 0);
