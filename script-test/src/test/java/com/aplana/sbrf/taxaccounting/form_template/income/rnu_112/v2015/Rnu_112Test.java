package com.aplana.sbrf.taxaccounting.form_template.income.rnu_112.v2015;
 ...
 */
public class Rnu_112Test extends ScriptTestBase {
    private static final int TYPE_ID = 824;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Rnu_112Test.class);
    }
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Валюта расчетов"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Дата первой части сделки"), entries.get(i++).getMessage());
    ...
    public void importExcelTest() {
        ...
        List<String> aliases = Arrays.asList("dealNum", "date1Part", "date2Part", "dealRate", "dealLeftSum", "bondSum", "payDate",
                "accrStartDate", "accrEndDate", "dealIncome", "rateDiff", "incomeCorrection");
    ...
    void checkLoadData(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(360, dataRows.get(0).getCell("yearBase").getNumericValue().intValue());
        Assert.assertEquals(365, dataRows.get(1).getCell("yearBase").getNumericValue().intValue());
    }
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        Assert.assertEquals(360, dataRows.get(0).getCell("yearBase").getNumericValue().intValue());
        Assert.assertEquals(365, dataRows.get(1).getCell("yearBase").getNumericValue().intValue());
        Assert.assertNull(dataRows.get(2).getCell("yearBase").getNumericValue());
    }
}
