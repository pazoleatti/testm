 ...
 * РНУ 101
 */
public class Rnu_101Test extends ScriptTestBase {
    private static final int TYPE_ID = 818;
    ...
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(Rnu_101Test.class);
    }
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Количество услуг/работ (ед./шт.)"), entries.get(i++).getMessage());
        ...
        row.getCell("incomeCode").setValue("1", null);
