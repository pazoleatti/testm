...
public class Rnu_101Test extends ScriptTestBase {
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        Assert.assertEquals(2, dataRows.get(4).getCell("sum1").getNumericValue().doubleValue(), 0);
        Assert.assertEquals(2, dataRows.get(4).getCell("sum2").getNumericValue().doubleValue(), 0);
    }
}
