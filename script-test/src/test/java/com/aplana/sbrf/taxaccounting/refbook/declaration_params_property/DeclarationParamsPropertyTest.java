package com.aplana.sbrf.taxaccounting.refbook.declaration_params_property;
...
/**
 * "Параметры представления деклараций по налогу на имущество" (id = 200)
 *
 * @author Emamedova
 */
public class DeclarationParamsPropertyTest extends RefBookScriptTestBase {

    @Override
    protected ScriptTestMockHelper getMockHelper() {
        return getDefaultScriptTestMockHelper(DeclarationParamsPropertyTest.class);
    }
