...
public class App_6_10_2Test extends ScriptTestBase {
    ...
    void checkAfterCalc(List<DataRow<Cell>> dataRows) {
        ...
        Assert.assertEquals(10, dataRows.get(1).getCell("price").getNumericValue().doubleValue(), 0);
        Assert.assertEquals(20, dataRows.get(2).getCell("price").getNumericValue().doubleValue(), 0);

        Assert.assertEquals(1, dataRows.get(0).getCell("cost").getNumericValue().doubleValue(), 0);
        Assert.assertEquals(10, dataRows.get(1).getCell("cost").getNumericValue().doubleValue(), 0);
        Assert.assertEquals(20, dataRows.get(2).getCell("cost").getNumericValue().doubleValue(), 0);
