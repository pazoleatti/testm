...
public class SummaryTest extends ScriptTestBase {
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals("Строка 1: Значение граф «п. 040 \"Код предмета сделки (код по ТН ВЭД)\"» и «п. 043 \"Код предмета сделки (код по ОКП)\"» не должны быть одновременно заполнены!", entries.get(i++).getMessage());
