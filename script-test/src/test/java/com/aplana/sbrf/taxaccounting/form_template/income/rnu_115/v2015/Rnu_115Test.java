...
public class Rnu_115Test extends ScriptTestBase {
    ...
    public void check1Test() throws ParseException {
        ...
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Дата окончания сделки"), entries.get(i++).getMessage());
        ...
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Код валюты (драгоценных металлов) по сделке приобретения (требования)"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Объем покупаемой валюты / драгоценных металлов (в граммах)"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Код валюты (драгоценных металлов) по сделке продажи (обязательства)"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Объем продаваемой валюты / драгоценных металлов (в граммах)"), entries.get(i++).getMessage());
        Assert.assertEquals(String.format(ScriptUtils.WRONG_NON_EMPTY, 1, "Цена сделки"), entries.get(i++).getMessage());
