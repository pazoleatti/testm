...
public class QRefBookAddress extends com.querydsl.sql.RelationalPathBase<QRefBookAddress> {
    ...
    private static final long serialVersionUID = -758537532;
    ...
    public QRefBookAddress(String variable, String schema) {
        super(QRefBookAddress.class, forVariable(variable), schema, "REF_BOOK_ADDRESS");
        addMetadata();
    }
