...
public class QDepartmentDeclarationType extends com.querydsl.sql.RelationalPathBase<QDepartmentDeclarationType> {
    ...
    private static final long serialVersionUID = -617474538;
    ...
    public QDepartmentDeclarationType(String variable, String schema) {
        super(QDepartmentDeclarationType.class, forVariable(variable), schema, "DEPARTMENT_DECLARATION_TYPE");
        addMetadata();
    }
