...
public class QEvent extends com.querydsl.sql.RelationalPathBase<QEvent> {
    ...
    private static final long serialVersionUID = 775927950;
    ...
    public final com.querydsl.sql.ForeignKey<QDeclTemplateEventScript> _decTempEventIdFk = createInvForeignKey(id, "EVENT_ID");
