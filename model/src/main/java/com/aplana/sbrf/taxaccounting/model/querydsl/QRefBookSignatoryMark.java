...
public class QRefBookSignatoryMark extends com.querydsl.sql.RelationalPathBase<QRefBookSignatoryMark> {
    ...
    private static final long serialVersionUID = -275704573;
    ...
    public QRefBookSignatoryMark(String variable, String schema) {
        super(QRefBookSignatoryMark.class, forVariable(variable), schema, "REF_BOOK_SIGNATORY_MARK");
        addMetadata();
    }
