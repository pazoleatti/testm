...
public class QRefBookFillBase extends com.querydsl.sql.RelationalPathBase<QRefBookFillBase> {
    ...
    private static final long serialVersionUID = -1550726620;
    ...
    public QRefBookFillBase(String variable, String schema) {
        super(QRefBookFillBase.class, forVariable(variable), schema, "REF_BOOK_FILL_BASE");
        addMetadata();
    }
