...
public class QRefBookIdDoc extends com.querydsl.sql.RelationalPathBase<QRefBookIdDoc> {
    ...
    private static final long serialVersionUID = 815505645;
    ...
    public QRefBookIdDoc(String variable, String schema) {
        super(QRefBookIdDoc.class, forVariable(variable), schema, "REF_BOOK_ID_DOC");
        addMetadata();
    }
