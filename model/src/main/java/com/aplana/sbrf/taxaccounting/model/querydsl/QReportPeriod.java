...
public class QReportPeriod extends com.querydsl.sql.RelationalPathBase<QReportPeriod> {
    ...
    private static final long serialVersionUID = -551362655;
    ...
    public QReportPeriod(String variable, String schema) {
        super(QReportPeriod.class, forVariable(variable), schema, "REPORT_PERIOD");
        addMetadata();
    }
