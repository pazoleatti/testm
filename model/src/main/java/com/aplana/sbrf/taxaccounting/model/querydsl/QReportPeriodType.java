...
public class QReportPeriodType extends com.querydsl.sql.RelationalPathBase<QReportPeriodType> {
    ...
    private static final long serialVersionUID = -845141381;
    ...
    public QReportPeriodType(String variable, String schema) {
        super(QReportPeriodType.class, forVariable(variable), schema, "REPORT_PERIOD_TYPE");
        addMetadata();
    }
