...
public class QRefBookCountry extends com.querydsl.sql.RelationalPathBase<QRefBookCountry> {
    ...
    private static final long serialVersionUID = 1346985574;
    ...
    public QRefBookCountry(String variable, String schema) {
        super(QRefBookCountry.class, forVariable(variable), schema, "REF_BOOK_COUNTRY");
        addMetadata();
    }
