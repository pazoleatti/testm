...
public class QRefBookBudgetIncome extends com.querydsl.sql.RelationalPathBase<QRefBookBudgetIncome> {
    ...
    private static final long serialVersionUID = -1043746690;
    ...
    public QRefBookBudgetIncome(String variable, String schema) {
        super(QRefBookBudgetIncome.class, forVariable(variable), schema, "REF_BOOK_BUDGET_INCOME");
        addMetadata();
    }
