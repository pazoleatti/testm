...
public class QMvFiasStreetAct extends com.querydsl.sql.RelationalPathBase<QMvFiasStreetAct> {
    ...
    private static final long serialVersionUID = 2117854885;
    ...
    public QMvFiasStreetAct(String variable, String schema) {
        super(QMvFiasStreetAct.class, forVariable(variable), schema, "MV_FIAS_STREET_ACT");
        addMetadata();
    }
