...
public class QDeclarationSource extends com.querydsl.sql.RelationalPathBase<QDeclarationSource> {
    ...
    private static final long serialVersionUID = 2100641321;
    ...
    public QDeclarationSource(String variable, String schema) {
        super(QDeclarationSource.class, forVariable(variable), schema, "DECLARATION_SOURCE");
        addMetadata();
    }
