...
public class QRefBookValue extends com.querydsl.sql.RelationalPathBase<QRefBookValue> {
    ...
    private static final long serialVersionUID = 827460673;
    ...
    public QRefBookValue(String variable, String schema) {
        super(QRefBookValue.class, forVariable(variable), schema, "REF_BOOK_VALUE");
        addMetadata();
    }
