...
public class QRefBookOkved extends com.querydsl.sql.RelationalPathBase<QRefBookOkved> {
    ...
    private static final long serialVersionUID = 821303049;
    ...
    public QRefBookOkved(String variable, String schema) {
        super(QRefBookOkved.class, forVariable(variable), schema, "REF_BOOK_OKVED");
        addMetadata();
    }
