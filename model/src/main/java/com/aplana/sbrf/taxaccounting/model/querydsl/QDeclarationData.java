...
public class QDeclarationData extends com.querydsl.sql.RelationalPathBase<QDeclarationData> {
    ...
    private static final long serialVersionUID = -829558472;
    ...
    public final NumberPath<Integer> departmentReportPeriodId = createNumber("departmentReportPeriodId", Integer.class);
    ...
    public final EnumPath<com.aplana.sbrf.taxaccounting.model.State> state = createEnum("state", com.aplana.sbrf.taxaccounting.model.State.class);
    ...
    public QDeclarationData(String variable, String schema) {
        super(QDeclarationData.class, forVariable(variable), schema, "DECLARATION_DATA");
        addMetadata();
    }
