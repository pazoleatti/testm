...
public class QRefBookOktmo extends com.querydsl.sql.RelationalPathBase<QRefBookOktmo> {
    ...
    private static final long serialVersionUID = 821301386;
    ...
    public QRefBookOktmo(String variable, String schema) {
        super(QRefBookOktmo.class, forVariable(variable), schema, "REF_BOOK_OKTMO");
        addMetadata();
    }
