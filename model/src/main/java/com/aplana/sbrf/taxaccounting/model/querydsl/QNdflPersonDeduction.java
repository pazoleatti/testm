...
public class QNdflPersonDeduction extends com.querydsl.sql.RelationalPathBase<QNdflPersonDeduction> {
    ...
    private static final long serialVersionUID = -686032152;
    ...
    public QNdflPersonDeduction(String variable, String schema) {
        super(QNdflPersonDeduction.class, forVariable(variable), schema, "NDFL_PERSON_DEDUCTION");
        addMetadata();
    }
