...
/**
 * QSchedTask is a Querydsl query type for QSchedTask
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QSchedTask extends com.querydsl.sql.RelationalPathBase<QSchedTask> {

    private static final long serialVersionUID = 476224607;

    public static final QSchedTask schedTask = new QSchedTask("SCHED_TASK");
    ...
    public final com.querydsl.sql.PrimaryKey<QSchedTask> sysC0016092 = createPrimaryKey(taskid);

    public QSchedTask(String variable) {
        super(QSchedTask.class, forVariable(variable), "NDFL_1_0", "SCHED_TASK");
        addMetadata();
    }

    public QSchedTask(String variable, String schema, String table) {
        super(QSchedTask.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QSchedTask(Path<? extends QSchedTask> path) {
        super(path.getType(), path.getMetadata(), "NDFL_1_0", "SCHED_TASK");
        addMetadata();
    }

    public QSchedTask(PathMetadata metadata) {
        super(QSchedTask.class, metadata, "NDFL_1_0", "SCHED_TASK");
        addMetadata();
    }
