...
public class QRefBookNdflRate extends com.querydsl.sql.RelationalPathBase<QRefBookNdflRate> {
    ...
    private static final long serialVersionUID = -806995156;
    ...
    public QRefBookNdflRate(String variable, String schema) {
        super(QRefBookNdflRate.class, forVariable(variable), schema, "REF_BOOK_NDFL_RATE");
        addMetadata();
    }
