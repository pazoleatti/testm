...
public class QRefBookRegion extends com.querydsl.sql.RelationalPathBase<QRefBookRegion> {
    ...
    private static final long serialVersionUID = -229505500;
    ...
    public QRefBookRegion(String variable, String schema) {
        super(QRefBookRegion.class, forVariable(variable), schema, "REF_BOOK_REGION");
        addMetadata();
    }
