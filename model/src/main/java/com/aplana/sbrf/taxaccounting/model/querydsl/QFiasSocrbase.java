...
public class QFiasSocrbase extends com.querydsl.sql.RelationalPathBase<QFiasSocrbase> {
    ...
    private static final long serialVersionUID = 1535004669;
    ...
    public QFiasSocrbase(String variable, String schema) {
        super(QFiasSocrbase.class, forVariable(variable), schema, "FIAS_SOCRBASE");
        addMetadata();
    }
