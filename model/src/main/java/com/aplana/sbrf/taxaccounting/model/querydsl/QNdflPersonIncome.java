...
public class QNdflPersonIncome extends com.querydsl.sql.RelationalPathBase<QNdflPersonIncome> {
    ...
    private static final long serialVersionUID = -1369305594;
    ...
    public QNdflPersonIncome(String variable, String schema) {
        super(QNdflPersonIncome.class, forVariable(variable), schema, "NDFL_PERSON_INCOME");
        addMetadata();
    }
