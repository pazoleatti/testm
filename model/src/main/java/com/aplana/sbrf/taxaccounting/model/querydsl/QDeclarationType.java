...
public class QDeclarationType extends com.querydsl.sql.RelationalPathBase<QDeclarationType> {
    ...
    private static final long serialVersionUID = -829058872;
    ...
    public QDeclarationType(String variable, String schema) {
        super(QDeclarationType.class, forVariable(variable), schema, "DECLARATION_TYPE");
        addMetadata();
    }
