...
public enum ReportType {
    ...
    MOVE_FD(4, "MOVE_FORM_DATA", "Переход между этапами %sформы", 20L, 120L),
    ...
    EDIT_FD(6, "EDIT_FORM_DATA", "Блокировка %sформы", 0L, 0L), //формально является задачей, нужна для блокирки формы в режиме редартирования/при консолидации приемника
