...
public class QRefBookPersonCategory extends com.querydsl.sql.RelationalPathBase<QRefBookPersonCategory> {
    ...
    private static final long serialVersionUID = 1564362403;
    ...
    public QRefBookPersonCategory(String variable, String schema) {
        super(QRefBookPersonCategory.class, forVariable(variable), schema, "REF_BOOK_PERSON_CATEGORY");
        addMetadata();
    }
