...
public class QDeclarationKind extends com.querydsl.sql.RelationalPathBase<QDeclarationKind> {
    ...
    private static final long serialVersionUID = -829342430;
    ...
    public QDeclarationKind(String variable, String schema) {
        super(QDeclarationKind.class, forVariable(variable), schema, "DECLARATION_KIND");
        addMetadata();
    }
