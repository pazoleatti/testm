...
public class QMvFiasLocalityAct extends com.querydsl.sql.RelationalPathBase<QMvFiasLocalityAct> {
    ...
    private static final long serialVersionUID = 436457413;
    ...
    public QMvFiasLocalityAct(String variable, String schema) {
        super(QMvFiasLocalityAct.class, forVariable(variable), schema, "MV_FIAS_LOCALITY_ACT");
        addMetadata();
    }
