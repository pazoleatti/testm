...
public class QRefBookAttachFileType extends com.querydsl.sql.RelationalPathBase<QRefBookAttachFileType> {
    ...
    private static final long serialVersionUID = -1772763285;
    ...
    public QRefBookAttachFileType(String variable, String schema) {
        super(QRefBookAttachFileType.class, forVariable(variable), schema, "REF_BOOK_ATTACH_FILE_TYPE");
        addMetadata();
    }
