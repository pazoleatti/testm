...
public class QRefBookIncomeType extends com.querydsl.sql.RelationalPathBase<QRefBookIncomeType> {
    ...
    private static final long serialVersionUID = 164458419;
    ...
    public QRefBookIncomeType(String variable, String schema) {
        super(QRefBookIncomeType.class, forVariable(variable), schema, "REF_BOOK_INCOME_TYPE");
        addMetadata();
    }
