...
public class QRefBookTaxPlaceType extends com.querydsl.sql.RelationalPathBase<QRefBookTaxPlaceType> {
    ...
    private static final long serialVersionUID = -2081780570;
    ...
    public QRefBookTaxPlaceType(String variable, String schema) {
        super(QRefBookTaxPlaceType.class, forVariable(variable), schema, "REF_BOOK_TAX_PLACE_TYPE");
        addMetadata();
    }
