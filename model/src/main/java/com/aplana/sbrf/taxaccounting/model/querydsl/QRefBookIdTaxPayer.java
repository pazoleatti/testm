...
public class QRefBookIdTaxPayer extends com.querydsl.sql.RelationalPathBase<QRefBookIdTaxPayer> {
    ...
    private static final long serialVersionUID = 1442546645;
    ...
    public QRefBookIdTaxPayer(String variable, String schema) {
        super(QRefBookIdTaxPayer.class, forVariable(variable), schema, "REF_BOOK_ID_TAX_PAYER");
        addMetadata();
    }
