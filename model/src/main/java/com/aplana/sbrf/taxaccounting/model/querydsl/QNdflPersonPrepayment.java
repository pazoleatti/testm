...
public class QNdflPersonPrepayment extends com.querydsl.sql.RelationalPathBase<QNdflPersonPrepayment> {
    ...
    private static final long serialVersionUID = 1670301664;
    ...
    public QNdflPersonPrepayment(String variable, String schema) {
        super(QNdflPersonPrepayment.class, forVariable(variable), schema, "NDFL_PERSON_PREPAYMENT");
        addMetadata();
    }
