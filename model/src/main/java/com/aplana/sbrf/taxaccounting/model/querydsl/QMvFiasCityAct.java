...
public class QMvFiasCityAct extends com.querydsl.sql.RelationalPathBase<QMvFiasCityAct> {
    ...
    private static final long serialVersionUID = -820997699;
    ...
    public QMvFiasCityAct(String variable, String schema) {
        super(QMvFiasCityAct.class, forVariable(variable), schema, "MV_FIAS_CITY_ACT");
        addMetadata();
    }
