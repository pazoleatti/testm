...
public class QConfigurationSchedulerParam extends com.querydsl.sql.RelationalPathBase<QConfigurationSchedulerParam> {
    ...
    private static final long serialVersionUID = -819948004;
    ...
    public QConfigurationSchedulerParam(String variable, String schema) {
        super(QConfigurationSchedulerParam.class, forVariable(variable), schema, "CONFIGURATION_SCHEDULER_PARAM");
        addMetadata();
    }
