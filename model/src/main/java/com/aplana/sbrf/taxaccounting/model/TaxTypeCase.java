...
public enum TaxTypeCase {
     ...
     * Фонды и Сборы
     */
    PFR('F', "Страховые сборы, взносы", "Страховых сборов, взносов", "Страховым сборам, взносам", "Страховые сборы, взносы", "Страховыми сборами, взносами", "Страховых сборах, взносах");
