...
public enum TaskInterruptCause {
    ...
    DECLARATION_TEMPLATE_JRXML_CHANGE("Выполнена замена jrxml файла макета налоговой формы", TASK_CANCEL),
    DECLARATION_DELETE("Удалена налоговая форма", TASK_CANCEL),
    DECLARATION_ACCEPT("Выполнено принятие экземпляра налоговой формы", TASK_CANCEL),
    DECLARATION_RECALCULATION("Выполнен пересчет данных налоговой формы", TASK_CANCEL),
