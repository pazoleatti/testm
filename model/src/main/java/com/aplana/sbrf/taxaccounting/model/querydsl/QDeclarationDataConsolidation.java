...
public class QDeclarationDataConsolidation extends com.querydsl.sql.RelationalPathBase<QDeclarationDataConsolidation> {
    ...
    private static final long serialVersionUID = 717555668;
    ...
    public QDeclarationDataConsolidation(String variable, String schema) {
        super(QDeclarationDataConsolidation.class, forVariable(variable), schema, "DECLARATION_DATA_CONSOLIDATION");
        addMetadata();
    }
