...
public class QFiasAddrobj extends com.querydsl.sql.RelationalPathBase<QFiasAddrobj> {
    ...
    private static final long serialVersionUID = 524692581;
    ...
    public QFiasAddrobj(String variable, String schema) {
        super(QFiasAddrobj.class, forVariable(variable), schema, "FIAS_ADDROBJ");
        addMetadata();
    }
