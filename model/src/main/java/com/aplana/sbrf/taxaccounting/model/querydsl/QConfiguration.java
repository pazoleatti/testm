...
public class QConfiguration extends com.querydsl.sql.RelationalPathBase<QConfiguration> {
    ...
    private static final long serialVersionUID = -707688726;
    ...
    public QConfiguration(String variable, String schema) {
        super(QConfiguration.class, forVariable(variable), schema, "CONFIGURATION");
        addMetadata();
    }
