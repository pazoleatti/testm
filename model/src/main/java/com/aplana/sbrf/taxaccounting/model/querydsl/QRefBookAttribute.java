...
public class QRefBookAttribute extends com.querydsl.sql.RelationalPathBase<QRefBookAttribute> {
    ...
    private static final long serialVersionUID = 328416620;
    ...
    public QRefBookAttribute(String variable, String schema) {
        super(QRefBookAttribute.class, forVariable(variable), schema, "REF_BOOK_ATTRIBUTE");
        addMetadata();
    }
