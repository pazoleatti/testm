...
public class QTaxType extends com.querydsl.sql.RelationalPathBase<QTaxType> {
    ...
    private static final long serialVersionUID = -1814327687;
    ...
    public QTaxType(String variable, String schema) {
        super(QTaxType.class, forVariable(variable), schema, "TAX_TYPE");
        addMetadata();
    }
