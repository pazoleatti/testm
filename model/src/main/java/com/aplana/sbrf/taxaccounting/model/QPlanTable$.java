...
/**
 * QPlanTable$ is a Querydsl query type for QPlanTable$
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QPlanTable$ extends com.querydsl.sql.RelationalPathBase<QPlanTable$> {

    private static final long serialVersionUID = -1277796484;

    public static final QPlanTable$ planTable$ = new QPlanTable$("PLAN_TABLE$");
    ...
    public QPlanTable$(String variable) {
        super(QPlanTable$.class, forVariable(variable), "SYS", "PLAN_TABLE$");
        addMetadata();
    }

    public QPlanTable$(String variable, String schema, String table) {
        super(QPlanTable$.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QPlanTable$(Path<? extends QPlanTable$> path) {
        super(path.getType(), path.getMetadata(), "SYS", "PLAN_TABLE$");
        addMetadata();
    }

    public QPlanTable$(PathMetadata metadata) {
        super(QPlanTable$.class, metadata, "SYS", "PLAN_TABLE$");
        addMetadata();
    }

    public void addMetadata() {
        addMetadata(accessPredicates, ColumnMetadata.named("ACCESS_PREDICATES").withIndex(32).ofType(Types.VARCHAR).withSize(4000));
        ...
        addMetadata(cpuCost, ColumnMetadata.named("CPU_COST").withIndex(29).ofType(Types.DECIMAL).withSize(22));
        addMetadata(depth, ColumnMetadata.named("DEPTH").withIndex(17).ofType(Types.DECIMAL).withSize(22));
        addMetadata(distribution, ColumnMetadata.named("DISTRIBUTION").withIndex(28).ofType(Types.VARCHAR).withSize(30));
        addMetadata(filterPredicates, ColumnMetadata.named("FILTER_PREDICATES").withIndex(33).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(id, ColumnMetadata.named("ID").withIndex(15).ofType(Types.DECIMAL).withSize(22));
        addMetadata(ioCost, ColumnMetadata.named("IO_COST").withIndex(30).ofType(Types.DECIMAL).withSize(22));
        ...
        addMetadata(otherXml, ColumnMetadata.named("OTHER_XML").withIndex(27).ofType(Types.CLOB).withSize(4000));
        ...
        addMetadata(projection, ColumnMetadata.named("PROJECTION").withIndex(34).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(qblockName, ColumnMetadata.named("QBLOCK_NAME").withIndex(36).ofType(Types.VARCHAR).withSize(30));
        ...
        addMetadata(tempSpace, ColumnMetadata.named("TEMP_SPACE").withIndex(31).ofType(Types.DECIMAL).withSize(22));
        addMetadata(time, ColumnMetadata.named("TIME").withIndex(35).ofType(Types.DECIMAL).withSize(22));
