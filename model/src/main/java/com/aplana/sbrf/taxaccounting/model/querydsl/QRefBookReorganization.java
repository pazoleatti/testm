...
public class QRefBookReorganization extends com.querydsl.sql.RelationalPathBase<QRefBookReorganization> {
    ...
    private static final long serialVersionUID = 1867118102;
    ...
    public QRefBookReorganization(String variable, String schema) {
        super(QRefBookReorganization.class, forVariable(variable), schema, "REF_BOOK_REORGANIZATION");
        addMetadata();
    }
