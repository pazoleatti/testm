...
public class RefBook implements Serializable {
	...
	public enum Id {
		// Особые справочники, со своей реализацией
		...
		TARIFF_PAYER(938),							// Коды тарифа плательщика страховых взносов
		HARD_WORK(939),								// Коды классов условий труда
		BUDGET_INCOME(940),							// Классификатор доходов бюджетов Российской Федерации
		PERSON(904), 								// Физ. лица
