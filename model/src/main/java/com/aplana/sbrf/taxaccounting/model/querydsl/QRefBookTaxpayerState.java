...
public class QRefBookTaxpayerState extends com.querydsl.sql.RelationalPathBase<QRefBookTaxpayerState> {
    ...
    private static final long serialVersionUID = 1621851895;
    ...
    public QRefBookTaxpayerState(String variable, String schema) {
        super(QRefBookTaxpayerState.class, forVariable(variable), schema, "REF_BOOK_TAXPAYER_STATE");
        addMetadata();
    }
