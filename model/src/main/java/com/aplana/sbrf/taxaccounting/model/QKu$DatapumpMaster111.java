...
/**
 * QKu$DatapumpMaster111 is a Querydsl query type for QKu$DatapumpMaster111
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QKu$DatapumpMaster111 extends com.querydsl.sql.RelationalPathBase<QKu$DatapumpMaster111> {

    private static final long serialVersionUID = 1275161408;

    public static final QKu$DatapumpMaster111 ku$DatapumpMaster111 = new QKu$DatapumpMaster111("KU$_DATAPUMP_MASTER_11_1");
    ...
    public QKu$DatapumpMaster111(String variable) {
        super(QKu$DatapumpMaster111.class, forVariable(variable), "SYS", "KU$_DATAPUMP_MASTER_11_1");
        addMetadata();
    }

    public QKu$DatapumpMaster111(String variable, String schema, String table) {
        super(QKu$DatapumpMaster111.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QKu$DatapumpMaster111(Path<? extends QKu$DatapumpMaster111> path) {
        super(path.getType(), path.getMetadata(), "SYS", "KU$_DATAPUMP_MASTER_11_1");
        addMetadata();
    }

    public QKu$DatapumpMaster111(PathMetadata metadata) {
        super(QKu$DatapumpMaster111.class, metadata, "SYS", "KU$_DATAPUMP_MASTER_11_1");
        addMetadata();
    }

    public void addMetadata() {
        addMetadata(abortStep, ColumnMetadata.named("ABORT_STEP").withIndex(87).ofType(Types.DECIMAL).withSize(22));
        addMetadata(ancestorProcessOrder, ColumnMetadata.named("ANCESTOR_PROCESS_ORDER").withIndex(35).ofType(Types.DECIMAL).withSize(22));
        addMetadata(baseObjectName, ColumnMetadata.named("BASE_OBJECT_NAME").withIndex(33).ofType(Types.VARCHAR).withSize(30));
        addMetadata(baseObjectSchema, ColumnMetadata.named("BASE_OBJECT_SCHEMA").withIndex(34).ofType(Types.VARCHAR).withSize(30));
        addMetadata(baseObjectType, ColumnMetadata.named("BASE_OBJECT_TYPE").withIndex(32).ofType(Types.VARCHAR).withSize(30));
        addMetadata(baseProcessOrder, ColumnMetadata.named("BASE_PROCESS_ORDER").withIndex(31).ofType(Types.DECIMAL).withSize(22));
        addMetadata(blockSize, ColumnMetadata.named("BLOCK_SIZE").withIndex(82).ofType(Types.DECIMAL).withSize(22));
        addMetadata(clusterOk, ColumnMetadata.named("CLUSTER_OK").withIndex(89).ofType(Types.DECIMAL).withSize(22));
        addMetadata(completedBytes, ColumnMetadata.named("COMPLETED_BYTES").withIndex(59).ofType(Types.DECIMAL).withSize(22));
        addMetadata(completedRows, ColumnMetadata.named("COMPLETED_ROWS").withIndex(8).ofType(Types.DECIMAL).withSize(22));
        addMetadata(completionTime, ColumnMetadata.named("COMPLETION_TIME").withIndex(25).ofType(Types.TIMESTAMP).withSize(7));
        addMetadata(controlQueue, ColumnMetadata.named("CONTROL_QUEUE").withIndex(71).ofType(Types.VARCHAR).withSize(30));
        addMetadata(creationLevel, ColumnMetadata.named("CREATION_LEVEL").withIndex(24).ofType(Types.DECIMAL).withSize(22));
        addMetadata(cumulativeTime, ColumnMetadata.named("CUMULATIVE_TIME").withIndex(63).ofType(Types.DECIMAL).withSize(22));
        addMetadata(dataBufferSize, ColumnMetadata.named("DATA_BUFFER_SIZE").withIndex(84).ofType(Types.DECIMAL).withSize(22));
        addMetadata(dataIo, ColumnMetadata.named("DATA_IO").withIndex(62).ofType(Types.DECIMAL).withSize(22));
        addMetadata(dbVersion, ColumnMetadata.named("DB_VERSION").withIndex(76).ofType(Types.VARCHAR).withSize(30));
        addMetadata(degree, ColumnMetadata.named("DEGREE").withIndex(85).ofType(Types.DECIMAL).withSize(22));
        addMetadata(domainProcessOrder, ColumnMetadata.named("DOMAIN_PROCESS_ORDER").withIndex(36).ofType(Types.DECIMAL).withSize(22));
        ...
        addMetadata(extendSize, ColumnMetadata.named("EXTEND_SIZE").withIndex(53).ofType(Types.DECIMAL).withSize(22));
        addMetadata(fileMaxSize, ColumnMetadata.named("FILE_MAX_SIZE").withIndex(54).ofType(Types.DECIMAL).withSize(22));
        addMetadata(fileName, ColumnMetadata.named("FILE_NAME").withIndex(52).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(fileType, ColumnMetadata.named("FILE_TYPE").withIndex(49).ofType(Types.DECIMAL).withSize(22));
        addMetadata(flags, ColumnMetadata.named("FLAGS").withIndex(21).ofType(Types.DECIMAL).withSize(22));
        addMetadata(grantor, ColumnMetadata.named("GRANTOR").withIndex(42).ofType(Types.VARCHAR).withSize(30));
        addMetadata(granules, ColumnMetadata.named("GRANULES").withIndex(40).ofType(Types.DECIMAL).withSize(22));
        addMetadata(guid, ColumnMetadata.named("GUID").withIndex(80).ofType(Types.VARBINARY).withSize(16));
        addMetadata(inProgress, ColumnMetadata.named("IN_PROGRESS").withIndex(14).ofType(Types.CHAR).withSize(1));
        addMetadata(instance, ColumnMetadata.named("INSTANCE").withIndex(88).ofType(Types.VARCHAR).withSize(60));
        addMetadata(isDefault, ColumnMetadata.named("IS_DEFAULT").withIndex(48).ofType(Types.DECIMAL).withSize(22));
        addMetadata(jobMode, ColumnMetadata.named("JOB_MODE").withIndex(70).ofType(Types.VARCHAR).withSize(30));
        addMetadata(jobVersion, ColumnMetadata.named("JOB_VERSION").withIndex(75).ofType(Types.VARCHAR).withSize(30));
        addMetadata(lastFile, ColumnMetadata.named("LAST_FILE").withIndex(67).ofType(Types.DECIMAL).withSize(22));
        addMetadata(lastUpdate, ColumnMetadata.named("LAST_UPDATE").withIndex(56).ofType(Types.TIMESTAMP).withSize(7));
        addMetadata(loadMethod, ColumnMetadata.named("LOAD_METHOD").withIndex(39).ofType(Types.DECIMAL).withSize(22));
        addMetadata(metadataBufferSize, ColumnMetadata.named("METADATA_BUFFER_SIZE").withIndex(83).ofType(Types.DECIMAL).withSize(22));
        addMetadata(metadataIo, ColumnMetadata.named("METADATA_IO").withIndex(61).ofType(Types.DECIMAL).withSize(22));
        addMetadata(name, ColumnMetadata.named("NAME").withIndex(45).ofType(Types.VARCHAR).withSize(30));
        ...
        addMetadata(objectNumber, ColumnMetadata.named("OBJECT_NUMBER").withIndex(58).ofType(Types.DECIMAL).withSize(22));
        addMetadata(objectPathSeqno, ColumnMetadata.named("OBJECT_PATH_SEQNO").withIndex(12).ofType(Types.DECIMAL).withSize(22));
        addMetadata(objectRow, ColumnMetadata.named("OBJECT_ROW").withIndex(28).ofType(Types.DECIMAL).withSize(22));
        addMetadata(objectSchema, ColumnMetadata.named("OBJECT_SCHEMA").withIndex(17).ofType(Types.VARCHAR).withSize(30));
        addMetadata(objectTablespace, ColumnMetadata.named("OBJECT_TABLESPACE").withIndex(26).ofType(Types.VARCHAR).withSize(30));
        ...
        addMetadata(oldValue, ColumnMetadata.named("OLD_VALUE").withIndex(65).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(operation, ColumnMetadata.named("OPERATION").withIndex(69).ofType(Types.VARCHAR).withSize(30));
        ...
        addMetadata(packetNumber, ColumnMetadata.named("PACKET_NUMBER").withIndex(64).ofType(Types.DECIMAL).withSize(22));
        addMetadata(parallelization, ColumnMetadata.named("PARALLELIZATION").withIndex(37).ofType(Types.DECIMAL).withSize(22));
        addMetadata(parentProcessOrder, ColumnMetadata.named("PARENT_PROCESS_ORDER").withIndex(44).ofType(Types.DECIMAL).withSize(22));
        addMetadata(partitionName, ColumnMetadata.named("PARTITION_NAME").withIndex(19).ofType(Types.VARCHAR).withSize(30));
        addMetadata(phase, ColumnMetadata.named("PHASE").withIndex(79).ofType(Types.DECIMAL).withSize(22));
        addMetadata(platform, ColumnMetadata.named("PLATFORM").withIndex(86).ofType(Types.VARCHAR).withSize(101));
        addMetadata(processingState, ColumnMetadata.named("PROCESSING_STATE").withIndex(29).ofType(Types.CHAR).withSize(1));
        addMetadata(processingStatus, ColumnMetadata.named("PROCESSING_STATUS").withIndex(30).ofType(Types.CHAR).withSize(1));
        addMetadata(processName, ColumnMetadata.named("PROCESS_NAME").withIndex(55).ofType(Types.VARCHAR).withSize(30));
        addMetadata(processOrder, ColumnMetadata.named("PROCESS_ORDER").withIndex(1).ofType(Types.DECIMAL).withSize(22));
        addMetadata(property, ColumnMetadata.named("PROPERTY").withIndex(22).ofType(Types.DECIMAL).withSize(22));
        addMetadata(remoteLink, ColumnMetadata.named("REMOTE_LINK").withIndex(73).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(scn, ColumnMetadata.named("SCN").withIndex(41).ofType(Types.DECIMAL).withSize(22));
        addMetadata(seed, ColumnMetadata.named("SEED").withIndex(66).ofType(Types.DECIMAL).withSize(22));
        addMetadata(serviceName, ColumnMetadata.named("SERVICE_NAME").withIndex(90).ofType(Types.VARCHAR).withSize(100));
        addMetadata(sizeEstimate, ColumnMetadata.named("SIZE_ESTIMATE").withIndex(27).ofType(Types.DECIMAL).withSize(22));
        addMetadata(startTime, ColumnMetadata.named("START_TIME").withIndex(81).ofType(Types.TIMESTAMP).withSize(7));
        addMetadata(state, ColumnMetadata.named("STATE").withIndex(78).ofType(Types.VARCHAR).withSize(30));
        addMetadata(statusQueue, ColumnMetadata.named("STATUS_QUEUE").withIndex(72).ofType(Types.VARCHAR).withSize(30));
        addMetadata(subpartitionName, ColumnMetadata.named("SUBPARTITION_NAME").withIndex(20).ofType(Types.VARCHAR).withSize(30));
        addMetadata(timezone, ColumnMetadata.named("TIMEZONE").withIndex(77).ofType(Types.VARCHAR).withSize(64));
        addMetadata(totalBytes, ColumnMetadata.named("TOTAL_BYTES").withIndex(60).ofType(Types.DECIMAL).withSize(22));
        addMetadata(trigflag, ColumnMetadata.named("TRIGFLAG").withIndex(23).ofType(Types.DECIMAL).withSize(22));
        addMetadata(unloadMethod, ColumnMetadata.named("UNLOAD_METHOD").withIndex(38).ofType(Types.DECIMAL).withSize(22));
        addMetadata(userDirectory, ColumnMetadata.named("USER_DIRECTORY").withIndex(50).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(userFileName, ColumnMetadata.named("USER_FILE_NAME").withIndex(51).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(userName, ColumnMetadata.named("USER_NAME").withIndex(68).ofType(Types.VARCHAR).withSize(30));
        addMetadata(valueN, ColumnMetadata.named("VALUE_N").withIndex(47).ofType(Types.DECIMAL).withSize(22));
        addMetadata(valueT, ColumnMetadata.named("VALUE_T").withIndex(46).ofType(Types.VARCHAR).withSize(4000));
        addMetadata(version, ColumnMetadata.named("VERSION").withIndex(74).ofType(Types.DECIMAL).withSize(22));
        addMetadata(workItem, ColumnMetadata.named("WORK_ITEM").withIndex(57).ofType(Types.VARCHAR).withSize(30));
        addMetadata(xmlClob, ColumnMetadata.named("XML_CLOB").withIndex(43).ofType(Types.CLOB).withSize(4000));
    }
