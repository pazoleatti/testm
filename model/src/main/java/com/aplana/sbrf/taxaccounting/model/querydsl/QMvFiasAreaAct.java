...
public class QMvFiasAreaAct extends com.querydsl.sql.RelationalPathBase<QMvFiasAreaAct> {
    ...
    private static final long serialVersionUID = 1942056795;
    ...
    public QMvFiasAreaAct(String variable, String schema) {
        super(QMvFiasAreaAct.class, forVariable(variable), schema, "MV_FIAS_AREA_ACT");
        addMetadata();
    }
