...
public class QRefBookDocType extends com.querydsl.sql.RelationalPathBase<QRefBookDocType> {
    ...
    private static final long serialVersionUID = -2077871262;
    ...
    public QRefBookDocType(String variable, String schema) {
        super(QRefBookDocType.class, forVariable(variable), schema, "REF_BOOK_DOC_TYPE");
        addMetadata();
    }
