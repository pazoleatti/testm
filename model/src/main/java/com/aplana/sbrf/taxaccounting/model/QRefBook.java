...
public class QRefBook extends com.querydsl.sql.RelationalPathBase<QRefBook> {
    ...
    private static final long serialVersionUID = -1270616481;
    ...
    public final com.querydsl.sql.ForeignKey<QFormDataRefBook> _formDataRefBookFkRefbook = createInvForeignKey(id, "REF_BOOK_ID");
