...
public class QConfigurationEmail extends com.querydsl.sql.RelationalPathBase<QConfigurationEmail> {
    ...
    private static final long serialVersionUID = 1635751634;
    ...
    public QConfigurationEmail(String variable, String schema) {
        super(QConfigurationEmail.class, forVariable(variable), schema, "CONFIGURATION_EMAIL");
        addMetadata();
    }
