...
public class QDeclarationTemplate extends com.querydsl.sql.RelationalPathBase<QDeclarationTemplate> {
    ...
    private static final long serialVersionUID = 1308776200;
    ...
    public QDeclarationTemplate(String variable, String schema) {
        super(QDeclarationTemplate.class, forVariable(variable), schema, "DECLARATION_TEMPLATE");
        addMetadata();
    }
