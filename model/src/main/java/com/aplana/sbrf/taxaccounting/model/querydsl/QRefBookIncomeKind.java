...
public class QRefBookIncomeKind extends com.querydsl.sql.RelationalPathBase<QRefBookIncomeKind> {
    ...
    private static final long serialVersionUID = 164174861;
    ...
    public QRefBookIncomeKind(String variable, String schema) {
        super(QRefBookIncomeKind.class, forVariable(variable), schema, "REF_BOOK_INCOME_KIND");
        addMetadata();
    }
