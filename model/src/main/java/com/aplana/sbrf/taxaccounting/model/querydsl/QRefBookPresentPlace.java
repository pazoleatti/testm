...
public class QRefBookPresentPlace extends com.querydsl.sql.RelationalPathBase<QRefBookPresentPlace> {
    ...
    private static final long serialVersionUID = 1621715004;
    ...
    public QRefBookPresentPlace(String variable, String schema) {
        super(QRefBookPresentPlace.class, forVariable(variable), schema, "REF_BOOK_PRESENT_PLACE");
        addMetadata();
    }
