...
public class QRefBookPerson extends com.querydsl.sql.RelationalPathBase<QRefBookPerson> {
    ...
    private static final long serialVersionUID = -286426491;
    ...
    public QRefBookPerson(String variable, String schema) {
        super(QRefBookPerson.class, forVariable(variable), schema, "REF_BOOK_PERSON");
        addMetadata();
    }
    ...
    public void addMetadata() {
        addMetadata(address, ColumnMetadata.named("ADDRESS").withIndex(12).ofType(Types.DECIMAL).withSize(18));
        addMetadata(birthDate, ColumnMetadata.named("BIRTH_DATE").withIndex(9).ofType(Types.TIMESTAMP).withSize(7));
        addMetadata(birthPlace, ColumnMetadata.named("BIRTH_PLACE").withIndex(10).ofType(Types.VARCHAR).withSize(255));
        addMetadata(citizenship, ColumnMetadata.named("CITIZENSHIP").withIndex(11).ofType(Types.DECIMAL).withSize(18));
        addMetadata(employee, ColumnMetadata.named("EMPLOYEE").withIndex(13).ofType(Types.DECIMAL).withSize(1));
        addMetadata(firstName, ColumnMetadata.named("FIRST_NAME").withIndex(3).ofType(Types.VARCHAR).withSize(60));
        addMetadata(id, ColumnMetadata.named("ID").withIndex(1).ofType(Types.DECIMAL).withSize(18).notNull());
        addMetadata(inn, ColumnMetadata.named("INN").withIndex(5).ofType(Types.VARCHAR).withSize(12));
        addMetadata(innForeign, ColumnMetadata.named("INN_FOREIGN").withIndex(6).ofType(Types.VARCHAR).withSize(50));
        ...
        addMetadata(oldId, ColumnMetadata.named("OLD_ID").withIndex(18).ofType(Types.DECIMAL).withSize(18));
        addMetadata(oldStatus, ColumnMetadata.named("OLD_STATUS").withIndex(19).ofType(Types.DECIMAL).withSize(1));
        addMetadata(recordId, ColumnMetadata.named("RECORD_ID").withIndex(14).ofType(Types.DECIMAL).withSize(18).notNull());
        addMetadata(snils, ColumnMetadata.named("SNILS").withIndex(7).ofType(Types.VARCHAR).withSize(14));
        addMetadata(sourceId, ColumnMetadata.named("SOURCE_ID").withIndex(17).ofType(Types.DECIMAL).withSize(18));
        addMetadata(status, ColumnMetadata.named("STATUS").withIndex(16).ofType(Types.DECIMAL).withSize(1).notNull());
        addMetadata(taxpayerState, ColumnMetadata.named("TAXPAYER_STATE").withIndex(8).ofType(Types.DECIMAL).withSize(18));
        addMetadata(version, ColumnMetadata.named("VERSION").withIndex(15).ofType(Types.TIMESTAMP).withSize(7).notNull());
    }
