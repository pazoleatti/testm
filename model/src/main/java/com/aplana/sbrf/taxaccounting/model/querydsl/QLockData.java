...
public class QLockData extends com.querydsl.sql.RelationalPathBase<QLockData> {
    ...
    private static final long serialVersionUID = 1786388737;

    public static final QLockData lockData = new QLockData("LOCK_DATA");

    public final DateTimePath<java.util.Date> dateLock = createDateTime("dateLock", java.util.Date.class);
    ...
    public QLockData(String variable, String schema) {
        super(QLockData.class, forVariable(variable), schema, "LOCK_DATA");
        addMetadata();
    }
