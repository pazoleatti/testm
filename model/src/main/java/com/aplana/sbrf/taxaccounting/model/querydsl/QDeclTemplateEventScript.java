...
public class QDeclTemplateEventScript extends com.querydsl.sql.RelationalPathBase<QDeclTemplateEventScript> {
    ...
    private static final long serialVersionUID = 151934741;
    ...
    public QDeclTemplateEventScript(String variable, String schema) {
        super(QDeclTemplateEventScript.class, forVariable(variable), schema, "DECL_TEMPLATE_EVENT_SCRIPT");
        addMetadata();
    }
