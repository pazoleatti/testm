...
public class QRefBookNdflDetail extends com.querydsl.sql.RelationalPathBase<QRefBookNdflDetail> {
    ...
    private static final long serialVersionUID = 1469621149;
    ...
    public QRefBookNdflDetail(String variable, String schema) {
        super(QRefBookNdflDetail.class, forVariable(variable), schema, "REF_BOOK_NDFL_DETAIL");
        addMetadata();
    }
