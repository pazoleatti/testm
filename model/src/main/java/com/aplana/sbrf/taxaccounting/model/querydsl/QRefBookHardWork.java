...
public class QRefBookHardWork extends com.querydsl.sql.RelationalPathBase<QRefBookHardWork> {
    ...
    private static final long serialVersionUID = -705142324;
    ...
    public QRefBookHardWork(String variable, String schema) {
        super(QRefBookHardWork.class, forVariable(variable), schema, "REF_BOOK_HARD_WORK");
        addMetadata();
    }
