...
public class RaschsvRashOssZakRash extends IdentityObject<Long> {
    ...
    public static final String COL_RASH_VSEGO = "rash_vsego";
    ...
    public static final String[] COLUMNS = {COL_ID, COL_RASCHSV_RASH_OSS_ZAK_ID, COL_NODE_NAME, COL_CHISL_SLUCH,
            COL_KOL_VYPL, COL_RASH_VSEGO, COL_RASH_FIN_FB};
    ...
    public BigDecimal getRashVsego() {
        return rashVsego;
    }
    public void setRashVsego(BigDecimal rashVsego) {
        this.rashVsego = rashVsego;
    }
