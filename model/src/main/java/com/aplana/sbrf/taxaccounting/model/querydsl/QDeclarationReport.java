...
public class QDeclarationReport extends com.querydsl.sql.RelationalPathBase<QDeclarationReport> {
    ...
    private static final long serialVersionUID = 2062625602;
    ...
    public QDeclarationReport(String variable, String schema) {
        super(QDeclarationReport.class, forVariable(variable), schema, "DECLARATION_REPORT");
        addMetadata();
    }
