...
public class QLogBusiness extends com.querydsl.sql.RelationalPathBase<QLogBusiness> {
    ...
    private static final long serialVersionUID = -538021401;
    ...
    public final com.querydsl.sql.ForeignKey<QFormData> logBusinessFkFormDataId = createForeignKey(formDataId, "ID");
    ...
    public void addMetadata() {
        addMetadata(declarationDataId, ColumnMetadata.named("DECLARATION_DATA_ID").withIndex(5).ofType(Types.DECIMAL).withSize(9));
        addMetadata(eventId, ColumnMetadata.named("EVENT_ID").withIndex(3).ofType(Types.DECIMAL).withSize(3).notNull());
        addMetadata(formDataId, ColumnMetadata.named("FORM_DATA_ID").withIndex(6).ofType(Types.DECIMAL).withSize(9));
        ...
        addMetadata(note, ColumnMetadata.named("NOTE").withIndex(7).ofType(Types.VARCHAR).withSize(510));
        addMetadata(roles, ColumnMetadata.named("ROLES").withIndex(4).ofType(Types.VARCHAR).withSize(2000).notNull());
        ...
        addMetadata(userLogin, ColumnMetadata.named("USER_LOGIN").withIndex(8).ofType(Types.VARCHAR).withSize(255).notNull());
    }
