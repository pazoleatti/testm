...
public class QRefBookDetachTaxPay extends com.querydsl.sql.RelationalPathBase<QRefBookDetachTaxPay> {
    ...
    private static final long serialVersionUID = 359160224;
    ...
    public QRefBookDetachTaxPay(String variable, String schema) {
        super(QRefBookDetachTaxPay.class, forVariable(variable), schema, "REF_BOOK_DETACH_TAX_PAY");
        addMetadata();
    }
