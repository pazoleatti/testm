...
public class QRefBookTariffPayer extends com.querydsl.sql.RelationalPathBase<QRefBookTariffPayer> {
    ...
    private static final long serialVersionUID = -35979423;
    ...
    public QRefBookTariffPayer(String variable, String schema) {
        super(QRefBookTariffPayer.class, forVariable(variable), schema, "REF_BOOK_TARIFF_PAYER");
        addMetadata();
    }
