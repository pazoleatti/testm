...
public class QAsyncTaskType extends com.querydsl.sql.RelationalPathBase<QAsyncTaskType> {
    ...
    private static final long serialVersionUID = -795399441;
    ...
    public QAsyncTaskType(String variable, String schema) {
        super(QAsyncTaskType.class, forVariable(variable), schema, "ASYNC_TASK_TYPE");
        addMetadata();
    }
