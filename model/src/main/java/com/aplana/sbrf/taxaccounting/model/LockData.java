...
public final class LockData {
    ...
    public enum DescriptionTemplate {
        ...
        LOG_SYSTEM_CSV("Формирование zip-архива с csv-файлом журнала аудита по параметрам поиска \"%s\""),
        IFRS("Формирование отчетности МСФО за период \"%s %s\""),
        CONFIGURATION_PARAMS("Блокировка общих параметров и параметров загрузки налоговых форм при загрузке ТФ"),
