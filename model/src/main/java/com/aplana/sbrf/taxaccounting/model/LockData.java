...
public final class LockData {
    ...
    public enum DescriptionTemplate {
        ...
        DECLARATION("Декларация \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_REPORT("Формирование отчета в формате %s для %s \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CREATE("Создание %s \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CALCULATE("Расчет %s \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CHECK("Проверка %s \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_ACCEPT("Принятии %s \"%s\", КПП \"%s\", налоговый орган \"%s\", подразделение \"%s\", период \"%s%s\""),
        FILE("Файл \"%s\""),
