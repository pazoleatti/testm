...
public final class LockData {
    ...
    public enum DescriptionTemplate {
        ...
        DECLARATION_REPORT("Формирование отчета в формате %s для декларации \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CREATE("Создание декларации \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CHECK("Проверка декларации \"%s\", подразделение \"%s\", период \"%s%s\""),
        FILE("Файл \"%s\""),
