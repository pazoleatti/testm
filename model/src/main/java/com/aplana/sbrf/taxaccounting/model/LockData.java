...
public final class LockData {
    ...
    public enum DescriptionTemplate {
        ...
        DECLARATION_REPORT("Формирование отчета в формате %s для %s \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CREATE("Создание %s \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CALCULATE("Расчет %s \"%s\", подразделение \"%s\", период \"%s%s\""),
        DECLARATION_CHECK("Проверка %s \"%s\", подразделение \"%s\", период \"%s%s\""),
        FILE("Файл \"%s\""),
