...
public class QRefBookDocState extends com.querydsl.sql.RelationalPathBase<QRefBookDocState> {
    ...
    private static final long serialVersionUID = 9413993;
    ...
    public QRefBookDocState(String variable, String schema) {
        super(QRefBookDocState.class, forVariable(variable), schema, "REF_BOOK_DOC_STATE");
        addMetadata();
    }
