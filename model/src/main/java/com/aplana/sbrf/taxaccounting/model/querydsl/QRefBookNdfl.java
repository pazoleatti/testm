...
public class QRefBookNdfl extends com.querydsl.sql.RelationalPathBase<QRefBookNdfl> {
    ...
    private static final long serialVersionUID = -527732692;
    ...
    public QRefBookNdfl(String variable, String schema) {
        super(QRefBookNdfl.class, forVariable(variable), schema, "REF_BOOK_NDFL");
        addMetadata();
    }
