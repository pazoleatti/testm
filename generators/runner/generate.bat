...
SET in=_______38_0000_00100031203200000000000000000kor9check1464v3.xml
 rem второй входной файл, у которого будут сгенерированны одинаковые данные для ФЛ как для первого файла (можно не указывать)
SET in2=FL_2018-02-16_13-40-17_628EAFC4B86F2FE8E05400144FFACA03.xml
