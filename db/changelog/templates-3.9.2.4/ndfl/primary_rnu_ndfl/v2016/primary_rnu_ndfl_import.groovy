        ...
        if (persistedPersonsById.isEmpty()) {
            ...
            for (NdflPersonExt ndflPerson : ndflPersons) {
                ...
                if (needPersonUpdate(ndflPerson)) {
                    ...
                    logForDebug("Трансформация операций и обновление номеров строк")
                    ...
                    logForDebug("Завершена трансформация операций и обновление номеров строк")
                }
            }
            ...
            logForDebug("Обновление существующих сведений о доходах ФЛ в базе")
            ndflPersonService.updateIncomes(incomesForUpdate)
            logForDebug("Обновление существующих сведений о вычетах ФЛ в базе")
            ndflPersonService.updateDeductions(deductionsForUpdate)
            logForDebug("Обновление существующих сведений о авансовых платежах ФЛ в базе")
            ...
            logForDebug("Обновление номеров строк реквизитов ФЛ в базе")
