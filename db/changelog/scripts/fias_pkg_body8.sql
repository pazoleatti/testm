        ...
        select t4.*,
          ...
          from (
                select t3.*,
                  ...
                  from (
                        select t2.*,
                               case when t2.region_code in ('77','78','92','99') and t2.city is null then then fias_pkg.CheckAddrElementRetID(t2.region_code,t2.city_fname,t2.city_type,null,'AREA',0)
