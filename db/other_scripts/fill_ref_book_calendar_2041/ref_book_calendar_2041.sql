...
BEGIN
  ...
  (
   select cdate + interval '22' year as cdate, c.ctype from ref_book_calendar c where c.cdate>=to_date('20190101','yyyymmdd') and c.cdate<to_date('20200301','yyyymmdd') order by c.cdate
  ) b
  ON (a.cdate=b.cdate)
