...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE SYNONYM DEPARTMENT FOR TAX_1_5_1.DEPARTMENT';
  ...
  EXECUTE IMMEDIATE 'CREATE SYNONYM SEC_ROLE FOR TAX_1_5_1.SEC_ROLE';

  EXECUTE IMMEDIATE 'drop synonym SEC_USER';
  EXECUTE IMMEDIATE 'CREATE SYNONYM SEC_USER FOR TAX_1_5_1.SEC_USER';

  EXECUTE IMMEDIATE 'drop synonym SEC_USER_ROLE';
  EXECUTE IMMEDIATE 'CREATE SYNONYM SEC_USER_ROLE FOR TAX_1_5_1.SEC_USER_ROLE';
  ...
  EXECUTE IMMEDIATE 'CREATE SYNONYM ADD_LOG_SYSTEM_NDFL FOR TAX_1_5_1.ADD_LOG_SYSTEM_NDFL';

  EXECUTE IMMEDIATE 'drop synonym SUBSYSTEM_ROLE';
  EXECUTE IMMEDIATE 'CREATE SYNONYM SUBSYSTEM_ROLE FOR TAX_1_5_1.SUBSYSTEM_ROLE';
END;
