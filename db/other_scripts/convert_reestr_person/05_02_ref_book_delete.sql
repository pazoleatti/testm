declare
	v_task_name varchar2(128):='insert_update_delete block #1 - delete from ref_book_person status <> 0';  
begin		
...
declare
	v_task_name varchar2(128):='insert_update_delete block #2 - delete from ref_book_id_doc status <> 0';  
begin		
	--https://jira.aplana.com/browse/SBRFNDFL-5837 Конвертировать данные реестра ФЛ
...
declare
	v_task_name varchar2(128):='insert_update_delete block #3 - delete from ref_book_id_tax_payer status <> 0';  
begin		
	--https://jira.aplana.com/browse/SBRFNDFL-5837 Конвертировать данные реестра ФЛ
...
declare
	v_task_name varchar2(128):='insert_update_delete block #4 - delete from ref_book_person_tb status <> 0';  
begin		
	--https://jira.aplana.com/browse/SBRFNDFL-5837 Конвертировать данные реестра ФЛ
