...
public class ConsolidateCredentialsCheckUnitTest {
    ...
    public void test_check_success() {
        ...
        assertTrue(consolidateCredentialsCheckUnit.check(logger, userInfo, declarationData, null));
    }
    ...
    public void test_check_fail() {
        ...
        assertFalse(consolidateCredentialsCheckUnit.check(logger, userInfo, declarationData, null));
    }
}