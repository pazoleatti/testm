...
public class SourceServiceTest {
    ...
    public void deleteSourcesWarnTest() throws ParseException {
        ...
        assertEquals("Тип: \"Первичная\", Вид: \"Прибыль\", Подразделение: \"Банк\", Период: \"1 квартал\", Месяц: Январь, Дата сдачи корректировки: 01.01.2014,  Версия: \"Абсолютные значения\"",
