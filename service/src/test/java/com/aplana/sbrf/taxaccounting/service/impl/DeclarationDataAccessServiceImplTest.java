...
public class DeclarationDataAccessServiceImplTest {
	...
	public void testCanRefresh() {
		...
		assertTrue(service.canRefresh(USER_CONTROL_UNP_ID, DECLARATION_CREATED_BANK_ID));
	...
	public void testCanAccept() {
		...
		assertTrue(service.canAccept(USER_CONTROL_UNP_ID, DECLARATION_CREATED_BANK_ID));
	...
	public void testCanReject() {
		...
		assertTrue(service.canReject(USER_CONTROL_UNP_ID, DECLARATION_ACCEPTED_BANK_ID));
	...
	public void testCanDelete() {
		...
		assertTrue(service.canDelete(USER_CONTROL_UNP_ID, DECLARATION_CREATED_BANK_ID));
	...
	public void testCanCreate() {
		...
		assertTrue(service.canCreate(USER_CONTROL_UNP_ID, DECLARATION_TEMPLATE_1_ID, Department.ROOT_BANK_ID, 1));
