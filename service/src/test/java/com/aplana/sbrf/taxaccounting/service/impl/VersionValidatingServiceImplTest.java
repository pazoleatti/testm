...
public class VersionValidatingServiceImplTest {
    ...
    public void isUsedVersionTest() throws ParseException {
        ...
        Assert.assertEquals(
                "Существует экземпляр налоговые формы:  Тип: \"Сводная\", Вид: \"Тестовый тип НФ\", Подразделение: \"Тестовое подразделение\", Период: \"Второй тестовый период 2014\", Период сравнения: Второй тестовый период 2014, Дата сдачи корректировки: 01.01.2014,  Версия: \"Корректировка\"",
