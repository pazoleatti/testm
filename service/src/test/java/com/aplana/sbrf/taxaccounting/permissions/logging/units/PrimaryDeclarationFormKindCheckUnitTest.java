...
public class PrimaryDeclarationFormKindCheckUnitTest {
    ...
    public void test_check_success() {
        ...
        assertTrue(primaryDeclarationFormKindCheckUnit.check(logger, taUserInfo, declarationData, null));
    }
    ...
    public void test_check_fail() {
        ...
        assertFalse(primaryDeclarationFormKindCheckUnit.check(logger, taUserInfo, declarationData, null));
    }
}