...
public class DeclarationDataServiceImplTest {
    ...
    public void getXmlSAXParserTest() {
        ...
        when(reportService.getSafeDec(declarationDataId1, DeclarationDataReportType.XML_DEC)).thenReturn(uuid1);
        when(reportService.getSafeDec(declarationDataId2, DeclarationDataReportType.XML_DEC)).thenReturn(uuid2);
    ...
    public void checkTest() {
        ...
        when(reportService.getSafeDec(anyLong(), Matchers.<DeclarationDataReportType>anyObject())).thenReturn(UUID.randomUUID().toString());
    ...
    public void getValueForCheckLimit() {
        ...
        when(declarationDataDao.get(declarationData.getId())).thenReturn(declarationData);
        when(reportService.getSafeDec(declarationData.getId(), DeclarationDataReportType.XML_DEC)).thenReturn("uuid1");
