...
public class RefBookHelperImplTest {
    ...
    public void init() {
        ...
        Map<Long, RefBookValue> result4 = new HashMap<>();
        ...
        RefBookCacheImpl rbCache = new RefBookCacheImpl(commonRefBookService, refBookFactory);

        ApplicationContext applicationContext = mock(ApplicationContext.class);
        when(applicationContext.getBean(RefBookCache.class)).thenReturn(rbCache);

        refBookHelper = new RefBookHelperImpl(applicationContext);
    }
