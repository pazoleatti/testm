...
public class DeclarationDataAccessServiceImplBalancePeriodTest {
    ...
    public static void tearUp() {
        ...
        DeclarationData declarationCreatedBank = mockDeclarationData((long) DECLARATION_CREATED_BANK_ID, State.CREATED, DECLARATION_TEMPLATE_1_ID, periods.get(BANK_REPORT_PERIOD_ID));
