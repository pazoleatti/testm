...
public class RefBookDepartmentDataProviderTest {

    @Rule
    public ExpectedException expectedException = ExpectedException.none();

    RefBookDepartmentDataProvider refBookDepartmentDataProvider = new RefBookDepartmentDataProvider();
    ...
    @Before
    public void setup() {
        ReflectionTestUtils.setField(refBookDepartmentDataProvider, "departmentService", departmentService);
        ReflectionTestUtils.setField(refBookDepartmentDataProvider, "refBookDao", refBookDao);
        ReflectionTestUtils.setField(refBookDepartmentDataProvider, "lockService", lockService);
        RefBookFactory refBookFactory = mock(RefBookFactoryImpl.class);
        ReflectionTestUtils.setField(refBookDepartmentDataProvider, "refBookFactory", refBookFactory);
    ...
    public void testDeleteRecordVersionsWhenDepartmentTypeIsRootBank() throws Exception {
        ...
        refBookDepartmentDataProvider.deleteRecordVersions(logger, list, true);
    }
}