...
public class JmsBaseConfig {
        ...
        public DefaultMessageListenerContainer jmsContainer(ConnectionFactory connectionFactory, BaseMessageReceiver baseMessageReceiver) throws NamingException {
