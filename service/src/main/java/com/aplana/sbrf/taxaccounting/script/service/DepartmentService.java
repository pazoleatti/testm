...
public interface DepartmentService {
    ...
    /**
     * Получение родительского территориального банка по списку идентификаторов физлиц
     * Реализовано для ускорения производительности скрипта формирования XSLX
     *
     * @param personId список идентификаторов физлиц
     * @return Список значений: Идентификатор физлица - Название родительского территориального банка
     */
    Map<Long, String> getParentTBbyPersonIdList(List<Long> personId);
