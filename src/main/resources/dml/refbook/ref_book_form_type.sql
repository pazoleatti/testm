--insert into ref_book_form_type(id,code,name) values(1,'Расчет 1151111','Расчет страховых взносов по форме 1151111');
insert into ref_book_form_type(id,code,name) values(2,'РНУ-НДФЛ','Регистр налогового учёта налога на доходы физических лиц');
