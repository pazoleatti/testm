...
if (row.logicalCheck != null && row.consumptionBuhSumAccepted != null) {
    row.opuSumByTableP = row.logicalCheck - row.consumptionBuhSumAccepted
} else {
...
b = getCellValue('R141', 'logicalCheck')
row.logicalCheck = a + b
// графа 12
...
//3, 5, 8....13, 16, 19..24, 34..38, 40..42, 44, 46..56, 58, 65..68, 70, 78..77, 80, 81, 83, 86, 87, 94-95?, 114, 116, 122, 123, 131-134, 139, 141-142?,
([3, 5] + (8..13) + [16] + (19..24) + (34..38) + (40..42) + [44] + (46..56) + [58] + (65..68) + [70, 80, 81, 83, 86, 87, 95, 114, 116, 122, 123] + (131..134) + [139]).each {
    ...
    getCell('R'+it, 'logicalCheck').setValue(
            summResult > 0 ? summResult:'Требуется объяснение'
    )
}
 ...
 */
([3, 5] + (8..13) + [16] + (19..24) + (34..38) + (40..42) + [44] + (46..56) + [58] + (65..68) + [70, 80, 81, 83, 86, 87, 94, 95, 114, 116, 122, 123] + (131..134) + [139, 141, 142]).each {
