package form_template.vat.declaration_9_1_3q2016.v2016
...
/**
 * Декларация по НДС (раздел 9.1 с 3 квартала 2016)
 *
 * declarationTemplateId=2027
 */
...
// текущая декларация
@Field
def declarationTypeId = 27

// декларация по НДС (раздел 9 без консолид. формы с 3 квартала 2016)
@Field
def declarationType9_sources = 24
