package form_template.vat.declaration_8_1_3q2016.v2016
...
/**
 * Декларация по НДС (раздел 8.1 с 3 квартала 2016)
 *
 * declarationTypeId=29
 * declarationTemplateId=1029
 */
...
@Field
def declarationType8 = 28
@Field
def declarationType8_1 = 29
@Field
def declarationType8Name = "Декларация по НДС (раздел 8 с 3 квартала 2016)"
@Field
def declarationType8_1Name = "Декларация по НДС (раздел 8.1 с 3 квартала 2016)"
@Field
def unpId = 1
@Field
...
void preXmlCheck() {
    ...
    if (corrNumber == 1) {
        ...
        def declarations = declarationService.find(declarationType8, departmentReportPeriods[0].id)
    ...
    def declarationTypeName = isFirstCorrection ? declarationType8Name : declarationType8_1Name
