...
void logicCheck() {
    ...
    def appFormData = formDataService.getLast(609, formData.kind, formData.departmentId, formData.reportPeriodId, formData.periodOrder, formData.comparativePeriodId, formData.accruing)
    if (appFormData) {
