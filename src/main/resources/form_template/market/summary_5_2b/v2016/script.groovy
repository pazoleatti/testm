 ...
 *
 * графа 1  (1)    - rowNum              - № пп
 * графа 2  (1.1)  - code                - ID сделки в CRM
 * графа 3  (2)    - name                - Информация о Клиенте. Наименование Клиента и ОПФ
 * графа 4  (3)    - country             - Информация о Клиенте. Страна регистрации (местоположения Клиента)
 * графа 5  (4)    - relatedPerson       - Информация о Клиенте. Взаимозависимое лицо Банка (Да / Нет)
 * графа 6  (5)    - offshore            - Информация о Клиенте. Резидент оффшорной зоны (Да / Нет)
 * графа 7  (6)    - innKio              - Информация о Клиенте. ИНН / КИО Клиента
 * графа 8  (7)    - creditRating        - Информация о Продукте / ИТФ. Кредитный рейтинг
 * графа 9  (8)    - internationalRating - Информация о Продукте / ИТФ. Международный кредитный рейтинг
 * графа 10 (9)    - number              - Информация о Продукте / ИТФ. Номер обязательства
 * графа 11 (10.1) - issuanceDate        - Информация о Продукте / ИТФ. Дата выдачи обязательства
 * графа 12 (10.2) - docDate             - Информация о Продукте / ИТФ. Дата заключения договора
 * графа 13 (11)   - endDate             - Информация о Продукте / ИТФ. Дата окончания действия обязательства
 * графа 14 (12)   - beneficiaryName     - Информация о Продукте / ИТФ. Наименование Бенефициара
 * графа 15 (13)   - beneficiaryInn      - Информация о Продукте / ИТФ. ИНН Бенефициара
 * графа 16 (14)   - period              - Информация о Продукте / ИТФ. Срок обязательства, лет
 * графа 17 (15)   - obligationType      - Информация о Продукте / ИТФ. Вид обязательства
 * графа 18 (16)   - currencyCode        - Информация о Продукте / ИТФ. Валюта обязательства
 * графа 19 (17)   - sum                 - Информация о Продукте / ИТФ. Сумма обязательства (по договору), ед. валюты
 * графа 20 (18)   - rate                - Информация о Продукте / ИТФ. Ставка вознаграждения, в % годовых
 * графа 21 (19)   - provisionPresence   - Информация о Продукте / ИТФ. Наличие обеспечения (Да / Нет)
 * графа 22 (20)   - currencyRate        - Информация о Продукте / ИТФ. Курс на дату выдачи обязательства
 * графа 23 (21)   - endSum              - Информация о Продукте / ИТФ. Сумма обязательства в рублях на дату выдачи
 * графа 24 (22)   - groupExclude        - Исключить из группировки (Да / Нет)
 */
...
def getSpRatingIds() {
    if (ratingIds.isEmpty()) {
        ...
        def records = getRecords(602L, filter, getReportPeriodEndDate())
        if (!records.isEmpty()) {
            ratingIds = records.collect { it.record_id.value }
        }
    }
    return ratingIds
}
