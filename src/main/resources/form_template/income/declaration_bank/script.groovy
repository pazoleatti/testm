...
// TODO (Ramil Timerbaev) проверить алиасы столбцов после того как будет готова переделанная в сводную выходная (проверить по всей декларации)
        ...
        Прибыль() {
            ...
            if (isBank) {
                ...
                РасчНал(
                    ...
                    /** СумНал. Столбец «Сумма налога в бюджет субъекта РФ». */
