package form_template.income.rnu84.v2016
...
@Field
def allColumns = ['rowNumber', 'dealNumber', 'name', 'date1', 'date2', 'date3','date4', 'upfront', 'upfrontCurrency',
                  'upfrontRub', 'fixedPayments1', 'fixedPayments2', 'fixedPayments3', 'fixedPayments4', 'rate',
                  'costMin', 'costMax', 'sumMin', 'sumMax', 'requirements', 'guaranty', 'income', 'outcome']
...
@Field
def nonEmptyColumns = ['dealNumber', 'name', 'date1', 'date2', 'upfront', 'upfrontRub', 'fixedPayments1', 'fixedPayments2',
                       'fixedPayments3', 'fixedPayments4', 'rate', 'requirements', 'guaranty', 'income', 'outcome']
