package form_template.income.rnu86.v2016
...
def allColumns = ['rowNumber', 'dealNumber', 'name', 'nameBond', 'series', 'bondKind', 'bondSign', 'bondNominal',
                  'bondCount', 'dealType', 'date1', 'date2', 'date3', 'dealPrice', 'option', 'optionCurrency', 'optionSum',
                  'optionRate', 'optionCostMin', 'optionCostMax', 'bondDate', 'bondCost', 'bondOutcome1', 'bondOutcome2',
                  'bondType', 'bondPrice1', 'bondPrice2', 'bondRate', 'sumMin', 'sumMax', 'income', 'outcome', 'delta']
...
@Field
def nonEmptyColumns = ['rowNumber', 'dealNumber', 'name', 'nameBond', 'series', 'bondKind', 'bondSign', 'bondNominal',
                       'bondCount', 'dealType', 'date1', 'date2', 'date3', 'dealPrice']
