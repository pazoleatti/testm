package form_template.income.rnu81.v2016
...
@Field
def allColumns = ['rowNumber', 'dealNumber', 'name', 'dealKind', 'date1', 'date2', 'date3','date4', 'option','optionCurrency',
                  'optionSum', 'rate', 'costMin', 'costMax', 'sumMin', 'sumMax', 'requirements', 'guaranty', 'income', 'outcome']
...
@Field
def nonEmptyColumns = ['dealNumber', 'name', 'dealKind', 'date1', 'date2', 'requirements', 'guaranty', 'income', 'outcome']
