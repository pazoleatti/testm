package form_template.income.rnu87.v2016
...
def allColumns = ['rowNumber', 'dealNumber', 'name', 'nameBond', 'series', 'bondKind', 'bondSign', 'bondNominal',
                  'bondCount', 'date1', 'date2', 'date3', 'dealPrice', 'bondDate', 'bondCost', 'bondOutcome1', 'bondOutcome2',
                  'bondType', 'bondPrice1', 'bondPrice2', 'bondRate', 'income', 'outcome', 'delta']
...
def nonEmptyColumns = ['rowNumber', 'dealNumber', 'name', 'nameBond', 'series', 'bondKind', 'bondSign', 'bondNominal',
                       'bondCount', 'date1', 'date2', 'date3', 'dealPrice']
