...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[0][16]): tmpRow.getCell('marketPrice').column.name]),
            ([(headerRows[0][17]): tmpRow.getCell('financialResult2').column.name]),
            ([(headerRows[0][18]): tmpRow.getCell('maxLoss').column.name]),
            ([(headerRows[0][19]): tmpRow.getCell('financialResultAdjustment').column.name]),
