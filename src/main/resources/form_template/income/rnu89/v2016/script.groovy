package form_template.income.rnu89.v2016
...
@Field
def allColumns = ['rowNumber', 'dealNumber', 'dealKind', 'name', 'date1', 'date2', 'date3','date4',
                  'requirements', 'guaranty', 'income', 'outcome']
...
@Field
def nonEmptyColumns = ['dealNumber', 'dealKind', 'name', 'date1', 'date2', 'requirements', 'guaranty']
