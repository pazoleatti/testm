package form_template.income.rnu80.v2016
...
@Field
def allColumns = ['rowNumber', 'dealNumber', 'dealKind', 'name', 'date1', 'date2', 'date3','date4', 'dealType','dealPrice1',
                  'dealPrice2', 'costMin', 'costMax', 'requirements', 'guaranty', 'income', 'outcome', 'sumMin', 'sumMax']
...
@Field
def nonEmptyColumns = ['dealNumber', 'dealKind', 'name', 'date1', 'date2', 'dealType','dealPrice1', 'dealPrice2',
                       'costMin', 'costMax', 'requirements', 'guaranty', 'income', 'outcome', 'sumMin', 'sumMax']
