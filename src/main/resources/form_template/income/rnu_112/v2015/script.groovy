...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[0][4]): tmpRow.getCell('iksr').column.name]),
            ([(headerRows[0][5]): tmpRow.getCell('countryName').column.name]),
            ([(headerRows[0][6]): tmpRow.getCell('code').column.name]),
            ([(headerRows[0][7]): tmpRow.getCell('currency').column.name]),
            ([(headerRows[0][8]): tmpRow.getCell('date1Part').column.name]),
            ([(headerRows[0][9]): tmpRow.getCell('date2Part').column.name]),
            ([(headerRows[0][10]): tmpRow.getCell('dealRate').column.name]),
            ([(headerRows[0][11]): tmpRow.getCell('dealLeftSum').column.name]),
            ([(headerRows[0][12]): tmpRow.getCell('bondSum').column.name]),
            ([(headerRows[0][13]): tmpRow.getCell('payDate').column.name]),
            ...
            ([(headerRows[0][16]): tmpRow.getCell('yearBase').column.name]),
            ([(headerRows[0][17]): tmpRow.getCell('dealIncome').column.name]),
            ([(headerRows[0][18]): tmpRow.getCell('rateDiff').column.name]),
            ([(headerRows[0][19]): tmpRow.getCell('incomeCorrection').column.name]),
            ([(headerRows[2][0]): '1'])
    ]
    (2..19).each {
