...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            (headerRows[0][3]) : getColumnName(tmpRow, 'dependence'),
            (headerRows[0][4]) : getColumnName(tmpRow, 'innKio'),
            (headerRows[0][5]) : getColumnName(tmpRow, 'country'),
            (headerRows[0][6]) : getColumnName(tmpRow, 'countryCode1'),
            (headerRows[0][7]) : getColumnName(tmpRow, 'contractNum'),
            (headerRows[0][8]) : getColumnName(tmpRow, 'contractDate'),
            (headerRows[0][9]) : getColumnName(tmpRow, 'transactionNum'),
            (headerRows[0][10]): getColumnName(tmpRow, 'dealType'),
            (headerRows[0][11]): getColumnName(tmpRow, 'transactionDeliveryDate'),
            (headerRows[1][12]): getColumnName(tmpRow, 'innerCode'),
            (headerRows[1][13]): getColumnName(tmpRow, 'unitCountryCode'),
            (headerRows[0][14]): getColumnName(tmpRow, 'signPhis'),
            (headerRows[0][15]): getColumnName(tmpRow, 'signTransaction'),
            (headerRows[1][16]): getColumnName(tmpRow, 'countryCode2'),
            (headerRows[1][17]): getColumnName(tmpRow, 'region1'),
            (headerRows[1][18]): getColumnName(tmpRow, 'city1'),
            (headerRows[1][19]): getColumnName(tmpRow, 'settlement1'),
            (headerRows[1][20]): getColumnName(tmpRow, 'countryCode3'),
            (headerRows[1][21]): getColumnName(tmpRow, 'region2'),
            (headerRows[1][22]): getColumnName(tmpRow, 'city2'),
            (headerRows[1][23]): getColumnName(tmpRow, 'settlement2'),
            (headerRows[0][24]): getColumnName(tmpRow, 'conditionCode'),
            (headerRows[0][25]): getColumnName(tmpRow, 'count'),
            (headerRows[0][26]): getColumnName(tmpRow, 'incomeSum'),
            (headerRows[0][27]): getColumnName(tmpRow, 'consumptionSum'),
            (headerRows[0][28]): getColumnName(tmpRow, 'priceOne'),
            (headerRows[0][29]): getColumnName(tmpRow, 'totalNds'),
            (headerRows[0][31]): getColumnName(tmpRow, 'transactionDate'),
            ...
            (headerRows[2][7]) : 'гр. 5',
            (headerRows[2][8]) : 'гр. 6',
            (headerRows[2][9]) : 'гр. 7.1',
            (headerRows[2][10]): 'гр. 7.2',
            (headerRows[2][11]): 'гр. 8',
            (headerRows[2][12]): 'гр. 9.1',
            (headerRows[2][13]): 'гр. 9.2',
            (headerRows[2][14]): 'гр. 10',
            (headerRows[2][15]): 'гр. 11',
            (headerRows[2][16]): 'гр. 12.1',
            (headerRows[2][17]): 'гр. 12.2',
            (headerRows[2][18]): 'гр. 12.3',
            (headerRows[2][19]): 'гр. 12.4',
            (headerRows[2][20]): 'гр. 13.1',
            (headerRows[2][21]): 'гр. 13.2',
            (headerRows[2][22]): 'гр. 13.3',
            (headerRows[2][23]): 'гр. 13.4',
            (headerRows[2][24]): 'гр. 14',
            (headerRows[2][25]): 'гр. 15',
            (headerRows[2][26]): 'гр. 16',
            (headerRows[2][27]): 'гр. 17',
            (headerRows[2][28]): 'гр. 18',
            (headerRows[2][29]): 'гр. 19',
            (headerRows[2][30]): '',
            (headerRows[2][31]): 'гр. 20'
    ]
