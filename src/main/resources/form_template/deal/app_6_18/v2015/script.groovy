...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][9]): tmpRow.getCell('dealDate').column.name]),
            ([(headerRows[1][10]): tmpRow.getCell('dealFocus').column.name]),
            ([(headerRows[1][11]): tmpRow.getCell('signPhis').column.name]),
            ([(headerRows[1][12]): tmpRow.getCell('metalName').column.name]),
            ([(headerRows[1][13]): tmpRow.getCell('foreignDeal').column.name]),
            ...
            ([(headerRows[1][22]): tmpRow.getCell('deliveryCode').column.name]),
            ([(headerRows[1][23]): tmpRow.getCell('count').column.name]),
            ([(headerRows[1][24]): tmpRow.getCell('incomeSum').column.name]),
            ([(headerRows[1][25]): tmpRow.getCell('outcomeSum').column.name]),
            ([(headerRows[1][26]): tmpRow.getCell('price').column.name]),
            ([(headerRows[1][27]): tmpRow.getCell('total').column.name]),
            ([(headerRows[1][28]): tmpRow.getCell('dealDoneDate').column.name]),
