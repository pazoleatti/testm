...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            (headerRows[1][3]) : tmpRow.getCell('fullName').column.name,
            (headerRows[1][3]) : tmpRow.getCell('inn').column.name,
            ...
            (headerRows[1][11]): tmpRow.getCell('currencyCode').column.name,
            (headerRows[1][12]): tmpRow.getCell('countryDealCode').column.name,
            (headerRows[1][13]): tmpRow.getCell('incomeSum').column.name,
            (headerRows[1][14]): tmpRow.getCell('outcomeSum').column.name,
            (headerRows[1][15]): tmpRow.getCell('price').column.name,
            (headerRows[1][16]): tmpRow.getCell('total').column.name,
            (headerRows[1][18]): tmpRow.getCell('dealDoneDate').column.name,
            (headerRows[2][0]) : 'гр. 1',
            (headerRows[2][2]) : 'гр. 2',
            (headerRows[2][3]) : 'гр. 3',
