package form_template.deal.app_6_22.v2015
...
/**
 * 6.22. Отчет в отношении расходов ПАО Сбербанк, связанных с привлечением гарантий
 *
 * formTemplateId = 834
 *
 * @author EMamedova
...
// графа 9  - sum          -  Сумма расходов Банка по данным бухгалтерского учета, руб.
