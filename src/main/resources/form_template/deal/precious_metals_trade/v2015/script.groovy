...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][2]) : tmpRow.getCell('fullName').column.name]),
            ([(headerRows[1][3]) : tmpRow.getCell('interdependence').column.name]),
            ([(headerRows[1][4]) : tmpRow.getCell('inn').column.name]),
            ([(headerRows[1][5]) : tmpRow.getCell('countryName').column.name]),
            ([(headerRows[1][6]) : tmpRow.getCell('countryCode').column.name]),
            ([(headerRows[1][7]) : tmpRow.getCell('docNumber').column.name]),
            ([(headerRows[1][8]) : tmpRow.getCell('docDate').column.name]),
            ([(headerRows[1][9]) : tmpRow.getCell('dealNumber').column.name]),
            ([(headerRows[1][10]): tmpRow.getCell('dealDate').column.name]),
            ([(headerRows[1][11]): tmpRow.getCell('dealFocus').column.name]),
            ([(headerRows[1][12]): tmpRow.getCell('deliverySign').column.name]),
            ([(headerRows[1][13]): tmpRow.getCell('metalName').column.name]),
            ([(headerRows[1][14]): tmpRow.getCell('foreignDeal').column.name]),
            ([(headerRows[1][15]): tmpRow.getCell('countryCodeNumeric').column.name]),
            ([(headerRows[1][16]): tmpRow.getCell('regionCode').column.name]),
            ([(headerRows[1][17]): tmpRow.getCell('city').column.name]),
            ([(headerRows[1][18]): tmpRow.getCell('locality').column.name]),
            ([(headerRows[1][19]): tmpRow.getCell('countryCodeNumeric2').column.name]),
            ([(headerRows[1][20]): tmpRow.getCell('region2').column.name]),
            ([(headerRows[1][21]): tmpRow.getCell('city2').column.name]),
            ([(headerRows[1][22]): tmpRow.getCell('locality2').column.name]),
            ([(headerRows[1][23]): tmpRow.getCell('deliveryCode').column.name]),
            ([(headerRows[1][24]): tmpRow.getCell('count').column.name]),
            ([(headerRows[1][25]): tmpRow.getCell('incomeSum').column.name]),
            ([(headerRows[1][26]): tmpRow.getCell('outcomeSum').column.name]),
            ([(headerRows[1][27]): tmpRow.getCell('price').column.name]),
            ([(headerRows[1][28]): tmpRow.getCell('total').column.name]),
            ([(headerRows[1][30]): tmpRow.getCell('dealDoneDate').column.name]),
            ([(headerRows[2][0]) : 'гр. 1']),
