...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][6]) : tmpRow.getCell('docNum').column.name]),
            ...
            ([(headerRows[1][10]): tmpRow.getCell('currencyCode').column.name]),
            ([(headerRows[1][11]): tmpRow.getCell('countryDealCode').column.name]),
            ([(headerRows[1][12]): tmpRow.getCell('incomeSum').column.name]),
            ([(headerRows[1][13]): tmpRow.getCell('outcomeSum').column.name]),
            ([(headerRows[1][14]): tmpRow.getCell('price').column.name]),
            ([(headerRows[1][15]): tmpRow.getCell('total').column.name]),
            ([(headerRows[1][17]): tmpRow.getCell('dealDoneDate').column.name]),
            ([(headerRows[2][0]) : 'гр. 1']),
            ([(headerRows[2][2]) : 'гр. 2']),
            ([(headerRows[2][3]) : 'гр. 3']),
