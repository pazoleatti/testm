...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][2]): tmpRow.getCell('dependence').column.name]),
            ...
            ([(headerRows[1][6]): tmpRow.getCell('docNumber').column.name]),
            ([(headerRows[1][7]): tmpRow.getCell('docDate').column.name]),
            ([(headerRows[1][8]): tmpRow.getCell('dealNumber').column.name]),
            ([(headerRows[1][9]): tmpRow.getCell('dealType').column.name]),
            ([(headerRows[1][10]): tmpRow.getCell('dealDate').column.name]),
            ([(headerRows[2][11]): tmpRow.getCell('innerCode').column.name]),
            ([(headerRows[2][12]): tmpRow.getCell('dealCountryCode').column.name]),
            ([(headerRows[1][13]): tmpRow.getCell('signPhis').column.name]),
            ([(headerRows[1][14]): tmpRow.getCell('signTransaction').column.name]),
            ([(headerRows[2][15]): tmpRow.getCell('countryCode2').column.name]),
            ([(headerRows[2][16]): tmpRow.getCell('region1').column.name]),
            ([(headerRows[2][17]): tmpRow.getCell('city1').column.name]),
            ([(headerRows[2][18]): tmpRow.getCell('settlement1').column.name]),
            ([(headerRows[2][19]): tmpRow.getCell('countryCode3').column.name]),
            ([(headerRows[2][20]): tmpRow.getCell('region2').column.name]),
            ([(headerRows[2][21]): tmpRow.getCell('city2').column.name]),
            ([(headerRows[2][22]): tmpRow.getCell('settlement2').column.name]),
            ([(headerRows[1][23]): tmpRow.getCell('conditionCode').column.name]),
            ([(headerRows[1][24]): tmpRow.getCell('count').column.name]),
            ([(headerRows[1][25]): tmpRow.getCell('income').column.name]),
            ([(headerRows[1][26]): tmpRow.getCell('outcome').column.name]),
            ([(headerRows[1][27]): tmpRow.getCell('price').column.name]),
            ([(headerRows[1][28]): tmpRow.getCell('cost').column.name]),
            ([(headerRows[1][29]): tmpRow.getCell('dealDoneDate').column.name]),
            ([(headerRows[3][0]): 'гр. 1']),
