package form_template.deal.auctions_property.v2012
...
def getNumber(def value, int indexRow, int indexCell) {
    ...
    try {
        ...
        throw new Exception("Проверка файла: Строка ${indexRow+14} столбец ${indexCell+2} содержит недопустимый тип данных!")
    }
}
