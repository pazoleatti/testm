...
void addRow() {
    ...
    for (alias in ['fullNamePerson', 'sum', 'docNumber', 'docDate', 'count', 'date']) {
...
void logicCheck() {
    for (row in formData.dataRows) {
        ...
        for (alias in [ 'fullNamePerson', 'inn', 'countryCode', 'sum', 'docNumber', 'docDate','count', 'price', 'cost', 'date']) {
