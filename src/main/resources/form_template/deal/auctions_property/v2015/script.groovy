package form_template.deal.auctions_property.v2015
...
/**
 * 3380 - Приобретение услуг по организации и проведению торгов по реализации имущества (5)
 *
 * formTemplateId=3380
 *
...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][10]): tmpRow.getCell('date').column.name])
    ]
    (0..10).each{
