package form_template.deal.bank_service_income.v2013
...
@Field
def nonEmptyColumns = ['jurName', 'bankIncomeSum', 'contractNum', 'contractDate', 'serviceName',
...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            (headerRows[0][3]): getColumnName(tmpRow, 'bankIncomeSum'),
            (headerRows[0][4]): getColumnName(tmpRow, 'contractNum'),
            (headerRows[0][5]): getColumnName(tmpRow, 'contractDate'),
            (headerRows[0][6]): getColumnName(tmpRow, 'serviceName'),
            (headerRows[0][7]): getColumnName(tmpRow, 'price'),
            (headerRows[0][8]): getColumnName(tmpRow, 'cost'),
