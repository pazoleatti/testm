package form_template.deal.app_6_19.v2015
...
/**
 * 6.19 Отчет в отношении расходов ПАО Сбербанк, связанных с привлечением ресурсов
 *
 * formTemplateId = 828
 *
 * @author EMamedova
...
// графа 4  (4)   - countryCode     - Страна регистрации
...
def refBookCache = [:]
@Field
def allColumns = ['fix', 'rowNumber', 'name', 'iksr', 'countryCode', 'count', 'sum', 'docNumber',
...
@Field
def totalColumns = ['sum', 'count', 'cost']
...
void importTransportData() {
    ...
    if (!logger.containsLevel(LogLevel.ERROR) && totalTF) {
        ...
        def totalColumnsIndexMap = ['sum': 5, 'count': 8, 'cost': 10]
