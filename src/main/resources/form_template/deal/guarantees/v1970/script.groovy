package form_template.deal.guarantees.v1970
...
@Field
def nonEmptyColumns = ['rowNumber', 'fullName', 'countryName', 'sum', 'price', 'total', 'dealDoneDate']
...
void addData(def xml, int headRowCount) {
    ...
    for (def row : xml.row) {
        ...
        // графа 1
        newRow.rowNumber = newRow.index = xmlIndexRow - headRowCount
        xmlIndexCol++
