package form_template.deal.app_6_24.v2015
...
/**
 * 6.24. Отчет в отношении прочих расходов ПАО Сбербанк, связанных с оказанием услуг
 *
 * formTemplateId = 833
 *
 * @author EMamedova
...
// графа 9  (9)   - price 			- Цена
// графа 10 (10)  - cost 			- Стоимость
// графа 11 (11)  - dealDoneDate    - Дата совершения сделки
...
def refBookCache = [:]
@Field
def allColumns = ['rowNumber', 'name', 'iksr', 'countryCode', 'sum', 'docNumber', 'docDate',
...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][7]) : getColumnName(tmpRow, 'serviceType')]),
