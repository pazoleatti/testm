package form_template.deal.bank_service.v2015
...
/**
 * 3382 - Оказание банковских услуг (7)
 *
 * formTemplateId=3382
 *
...
void checkHeaderXls(def headerRows, def colCount, rowCount, def tmpRow) {
    ...
    def headerMapping = [
            ...
            ([(headerRows[1][6]): tmpRow.getCell('bankIncomeSum').column.name]),
            ...
            ([(headerRows[1][11]): tmpRow.getCell('transactionDate').column.name]),
            ([(headerRows[2][0]): 'гр. 1']),
            ([(headerRows[2][1]): 'гр. 2']),
            ([(headerRows[2][2]): 'гр. 3']),
