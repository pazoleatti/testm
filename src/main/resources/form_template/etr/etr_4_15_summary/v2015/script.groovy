...
// графа 2  - comparePeriod			Период сравнения. НДС всего
// графа 3  - comparePeriodIgnore	Период сравнения. В том числе НДС не учитываемый
// графа 4  - comparePeriodPercent	Период сравнения. Доля НДС не учитываемый, %
// графа 5  - currentPeriod			Период. НДС всего
// графа 6  - currentPeriodIgnore	Период. В том числе НДС не учитываемый
// графа 7  - currentPeriodPercent	Период. Доля НДС не учитываемый, %
// графа 8  - delta					Изменения за период. НДС всего
// графа 9  - deltaIgnore			Изменения за период. В том числе НДС не учитываемый
...
void checkHeaderXls(def headerRows, def colCount, rowCount) {
    ...
    def headerMapping = [
            ...
            (headerRows[1][2]) : 'НДС всего',
            (headerRows[1][3]) : 'В том числе НДС не учитываемый',
            (headerRows[1][4]) : 'Доля НДС не учитываемый, %',
            (headerRows[1][5]) : 'НДС всего',
            (headerRows[1][6]) : 'В том числе НДС не учитываемый',
            (headerRows[1][7]) : 'Доля НДС не учитываемый, %',
            (headerRows[1][8]) : 'НДС всего',
            (headerRows[1][9]) : 'В том числе НДС не учитываемый',
