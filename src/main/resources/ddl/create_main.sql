...
comment on column raschsv_pers_sv_strah_lic.raschsv_sv_vypl_id is 'Внешний ключ на Сведения о сумме выплат и иных вознаграждений, начисленных в пользу физического лица';
comment on column raschsv_pers_sv_strah_lic.raschsv_vypl_sv_dop_id is 'Внешний ключ на Сведения о сумме выплат и иных вознаграждений, начисленных в пользу физического лица, на которые исчислены страховые взносы по дополнительному тарифу';
------------------------------------------------------------------------------------------------------
