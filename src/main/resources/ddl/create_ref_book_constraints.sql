...
alter table ref_book_ndfl_detail add constraint fk_ref_book_ndfl_det_oblig foreign key(obligation) references ref_book_detach_tax_pay(id);
...
alter table ref_book_ndfl_detail add constraint fk_ref_book_ndfl_det_dept foreign key(department_id) references department(id);
...
alter table ref_book_fond_detail add constraint fk_ref_book_fond_det_oblig foreign key(obligation) references ref_book_detach_tax_pay(id);
...
alter table ref_book_fond_detail add constraint fk_ref_book_fond_det_dept foreign key(department_id) references department(id);
