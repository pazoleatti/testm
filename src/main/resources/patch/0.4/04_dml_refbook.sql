...
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3102, 310,'Код налогового органа','TAX_ORGAN_CODE',1,2,null,null,1,null,10,0,1,null,null,0,4);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3103, 310,'КПП','KPP',1,3,null,null,1,null,10,0,1,null,null,0,9);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3104, 310,'Код по месту нахождения (учета)','TAX_PLACE_TYPE_CODE',4,4,2,3,1,null,10,0,0,null,null,0,null);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3105, 310,'Наименование (налогоплательщик)','NAME',1,5,null,null,1,null,100,0,0,null,null,0,1000);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3106, 310,'ОКВЭД','OKVED_CODE',4,6,34,210,1,null,10,0,0,null,null,0,null);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3107, 310,'Номер контактного телефона','PHONE',1,7,null,null,1,null,20,0,0,null,null,0,20);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3108, 310,'Обязанность по уплате авансовых платежей','PREPAYMENT',2,8,null,null,1,0,10,0,0,null,null,0,1);
...
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3113, 310,'Фамилия подписанта','SIGNATORY_SURNAME',1,13,null,null,1,null,100,0,0,null,null,0,60);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3114, 310,'Имя подписанта','SIGNATORY_FIRSTNAME',1,14,null,null,1,null,100,0,0,null,null,0,60);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3115, 310,'Отчество подписанта','SIGNATORY_LASTNAME',1,15,null,null,1,null,100,0,0,null,null,0,60);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3116, 310,'Наименование документа представителя','APPROVE_DOC_NAME',1,16,null,null,1,null,100,0,0,null,null,0,120);
INSERT INTO ref_book_attribute (id, ref_book_id, name, alias, type, ord, reference_id, attribute_id, visible, precision, width, required, is_unique, sort_order, format, read_only, max_length) VALUES (3117, 310,'Наименование организации представителя','APPROVE_ORG_NAME',1,17,null,null,1,null,100,0,0,null,null,0,1000);
