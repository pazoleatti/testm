...
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (3,'Формирование XLSM-файла налоговой формы','ejb/taxaccounting/async-task.jar/XlsmGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',30000,2000000,'Количество ячеек таблицы формы = Количество строк * Количество граф',0);
...
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (6,'Расчет декларации/уведомления (формирование XML-файла)','ejb/taxaccounting/async-task.jar/XmlGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,'Сумма количества ячеек таблицы формы по всем формам источникам. Количество ячеек таблицы формы источника = Количество строк * Количество граф',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (7,'Формирование формы предварительного просмотра декларации/уведомления','ejb/taxaccounting/async-task.jar/PdfGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',15,7000,'Размер XML-файла декларации/уведомления (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (9,'Формирование отчетности для МСФО','ejb/taxaccounting/async-task.jar/IfrsGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,'Общий размер файлов форм МСФО (налоговая форма - XLSM, декларация/уведомление - XLSX',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (10,'Архивация ЖА','ejb/taxaccounting/async-task.jar/CsvAuditArchiveGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,null,0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (11,'Генерация отчета ЖА','ejb/taxaccounting/async-task.jar/CsvAuditGeneratorAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,null,0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (12,'Загрузка ТФ налоговой формы с локального компьютера','ejb/taxaccounting/async-task.jar/UploadTransportDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',50000,800000,'Размер ТФ (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (13,'Загрузка ТФ налоговой формы из каталога загрузки','ejb/taxaccounting/async-task.jar/LoadAllTransportDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',10000,800000,'Размер ТФ (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (14,'Проверка декларации/уведомления','ejb/taxaccounting/async-task.jar/CheckDeclarationAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,'Размер XML-файла декларации/уведомления (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (15,'Принятии декларации/уведомления','ejb/taxaccounting/async-task.jar/AcceptDeclarationAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,'Размер XML-файла декларации/уведомления (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (16,'Консолидация в налоговую форму','ejb/taxaccounting/async-task.jar/ConsolidateFormDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1,null,'Сумма количества ячеек таблицы формы по всем формам источникам. Количество ячеек таблицы формы источника = Количество строк * Количество граф',0);
...
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (18,'Загрузка XLSM-файла с формы экземпляра налоговой формы','ejb/taxaccounting/async-task.jar/UploadFormDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',50,null,'Размер файла (Кбайт)',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (19,'Проверка налоговой формы','ejb/taxaccounting/async-task.jar/CheckFormDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',1000000,15000000,'Количество ячеек таблицы формы = Количество строк * Количество граф',0);
INSERT INTO async_task_type(ID, NAME, HANDLER_JNDI, SHORT_QUEUE_LIMIT, TASK_LIMIT, LIMIT_KIND, DEV_MODE) VALUES (20,'Подготовка/утверждение/принятие налоговой формы','ejb/taxaccounting/async-task.jar/MoveFormDataAsyncTaskImpl#com.aplana.sbrf.taxaccounting.async.task.AsyncTaskRemote',15000,null,'Количество ячеек таблицы формы = Количество строк * Количество граф',0);
