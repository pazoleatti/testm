 ...
 */
class CustomCellBasedWidgetImplTrident extends CellBasedWidgetImpl {
	...
	public CustomCellBasedWidgetImplTrident() {
	...
	private native void initFocusEventSystem() /*-{
        @com.google.gwt.user.cellview.client.CustomCellBasedWidgetImplTrident::dispatchFocusEvent = $entry(function() {
            @com.google.gwt.user.cellview.client.CustomCellBasedWidgetImplTrident::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)($wnd.event);
        });
    }-*/;
	...
	private native void sinkFocusEvents(Element elem) /*-{
        elem.attachEvent('onfocusin',
            @com.google.gwt.user.cellview.client.CustomCellBasedWidgetImplTrident::dispatchFocusEvent);
