    ...
    private void initColumns() {
        ...
        DataRowColumn<String> fileNameColumnUI = new DataRowColumn<String>(new ClickableTextCell(), fileNameColumn) {
            ...
            public void render(com.google.gwt.cell.client.Cell.Context context, DataRow<Cell> object, SafeHtmlBuilder sb) {
                String link = "<a href=\"" + GWT.getHostPageBaseURL() + "controller/actions/downloadBlobController/DeclarationDataFile/" + object.getCell(uuidColumn.getAlias()).getStringValue() + "\">" + object.getCell(fileNameColumn.getAlias()).getStringValue() + "</a>";
