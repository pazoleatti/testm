...
/**
 * The base class of {@link ContactPagePresenter}. The goal of this class is just to show that
 ...
 */
public abstract class ContactPagePresenterBase<Proxy_ extends Proxy<?>>
    extends Presenter<ContactPagePresenterBase.MyView, Proxy_> {

  String navigationHistory = "";

  /**
   * {@link ContactPagePresenter}'s view.
   */
  public interface MyView extends View {
    void setNavigationHistory(String navigationHistory);
  }

  public ContactPagePresenterBase(EventBus eventBus, MyView view, Proxy_ proxy) {
