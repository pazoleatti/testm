...
public class PopUpWithTree extends Composite implements PopUpWithTreeView, HasHandlers {
	...
	private List<TreeItem> flatToHierarchy(List<Department> list, Set<Integer> availableDepartments) {
		Map<Integer, TreeItem> lookup = new TreeMap<Integer, TreeItem>();
		List<TreeItem> nested = new ArrayList<TreeItem>();
