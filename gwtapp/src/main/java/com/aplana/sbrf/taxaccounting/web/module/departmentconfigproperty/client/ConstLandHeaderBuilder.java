...
public class ConstLandHeaderBuilder extends AbstractHeaderOrFooterBuilder implements TableWithCheckedColumn {

    public ConstLandHeaderBuilder(DataGrid table) {
        super(table, false);
    }
    ...
    protected boolean buildHeaderOrFooterImpl() {
        ...
        buildHeader(tr, new TextHeader("Ответственный за налоговую форму"), 7, 0, true);
