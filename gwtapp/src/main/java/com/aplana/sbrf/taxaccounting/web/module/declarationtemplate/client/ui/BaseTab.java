...
package com.aplana.sbrf.taxaccounting.web.module.declarationtemplate.client.ui;
...
/**
 * This is a basic implementation of a {@link com.gwtplatform.mvp.client.Tab} that must be
 * subclassed. Subclasses can style the tab in any way they want.
 * A {@link com.aplana.sbrf.taxaccounting.web.module.declarationtemplate.client.ui.BaseTab} is added to a {@link BaseTabPanel}.
 *
...
public abstract class BaseTab extends Composite implements Tab {
  /**
   * {@link com.aplana.sbrf.taxaccounting.web.module.declarationtemplate.client.ui.BaseTab}'s CssResource.
   */
