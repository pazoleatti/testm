...
public class DeclarationTemplateFilesPresenter
    ...
    public void downloadFile() {
        if (getView().getDeclarationTemplateFile().getBlobDataId() != null) {
            DownloadUtils.openInIframe(GWT.getHostPageBaseURL() + "controller/actions/declarationTemplate/downloadByUuid/" + getView().getDeclarationTemplateFile().getBlobDataId());
        }
    }
