...
/**
 * This is a basic implementation of a {@link com.gwtplatform.mvp.client.TabPanel} that must be
 * subclassed. Subclasses can style the tab panel in any way they want.
 * A {@link com.aplana.sbrf.taxaccounting.web.module.declarationtemplate.client.ui.BaseTabPanel} will hold a number of {@link BaseTab}.
 *
...
public abstract class BaseTabPanel extends Composite implements TabPanel {
  ...
  public List<BaseTab> getTabList() {
		return tabList;
  }
}