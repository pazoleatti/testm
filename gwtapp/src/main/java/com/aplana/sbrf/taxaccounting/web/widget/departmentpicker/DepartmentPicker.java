...
public class DepartmentPicker extends Composite{
	...
	private final Map<String, Integer> allTreeItems = new TreeMap<String, Integer>();
	private final Map<String, Integer> selectedItems = new HashMap<String, Integer>();
	private final Map<Integer, Pair<Integer, DepartmentItem>> nodes = new LinkedHashMap<Integer, Pair<Integer, DepartmentItem>>();
	...
	@UiConstructor
	public DepartmentPicker(String popupPanelCaption) {
		this(popupPanelCaption, true);
	}

	@UiConstructor
	public DepartmentPicker(String popupPanelCaption, boolean isMultiselect) {
	...
	private boolean createTree(){
		...
		//имя подразделения.
		Collections.sort(sourceList, new DepartmentComparator());
