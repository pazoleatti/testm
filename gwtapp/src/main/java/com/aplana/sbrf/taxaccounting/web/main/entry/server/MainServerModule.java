...
import com.aplana.sbrf.taxaccounting.web.module.formsources.server.FormSourcesServerModule;
...
@Import(value = {MainHandlerModule.class,  FormDataListServerModule.class,
        ...
        AuditFormServerModule.class, PeriodsServerModule.class, LogAreaModule.class, FormSourcesServerModule.class})
