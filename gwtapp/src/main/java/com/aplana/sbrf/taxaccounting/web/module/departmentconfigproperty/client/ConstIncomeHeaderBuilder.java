...
public class ConstIncomeHeaderBuilder extends AbstractHeaderOrFooterBuilder implements TableWithCheckedColumn {

    public ConstIncomeHeaderBuilder(DataGrid table) {
        super(table, false);
    }
    ...
    protected boolean buildHeaderOrFooterImpl() {
        ...
        buildHeader(tr, new TextHeader("Условия расчетов для ОП"), 2, 0, true);
