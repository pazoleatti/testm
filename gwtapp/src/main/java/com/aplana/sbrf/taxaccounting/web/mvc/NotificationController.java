...
public class NotificationController {
    ...
    public JqgridPagedList<Notification> fetchNotifications(
            ...
            @RequestParam(required = false) @DateTimeFormat(pattern = "dd.MM.yyyy HH:ss") Date timeFrom,
            @RequestParam(required = false) @DateTimeFormat(pattern = "dd.MM.yyyy HH:ss") Date timeTo) {
