...
/**
 * http://jira.aplana.com/browse/SBRFACCTAX-4649
 * корректно отображается в IE8, FF, Chrome
 */
@SuppressWarnings("deprecation")
public class FixedScrollPanel extends SimplePanel implements SourcesScrollEvents,
...
//		DOM.setStyleAttribute(containerElem, "zoom", "1");
     ...
     */
    public FixedScrollPanel(Widget child) {
        this();
        setWidget(child);
    }
