...
public class ImportHandler extends AbstractActionHandler<ImportAction, ImportResult> {
    ...
    public ImportResult execute(ImportAction importAction, ExecutionContext executionContext) throws ActionException {
        ...
        service.importData(blobData.getName(), blobData.getInputStream(), importAction.getAccountPeriodId(), importAction.getTypeId(), importAction.getDepartmentId(), securityService.currentUserInfo());
        return importResult;
    }
