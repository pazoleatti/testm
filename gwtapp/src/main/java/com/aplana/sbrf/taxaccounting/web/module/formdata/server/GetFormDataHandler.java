...
public class GetFormDataHandler extends AbstractActionHandler<GetFormDataAction, GetFormDataResult> {
	...
	private void fillFormAndTemplateData(GetFormDataAction action, TAUserInfo userInfo, Logger logger,
        ...
        result.setEventScriptStatus(formDataService.getEventScriptStatus(formTemplate));
        ...
        if (specialPeriod.getName() != null) {
            departmentReportPeriod.getReportPeriod().setName(specialPeriod.getName());
            departmentReportPeriod.getReportPeriod().setCalendarStartDate(specialPeriod.getCalendarStartDate());
            departmentReportPeriod.getReportPeriod().setEndDate(specialPeriod.getEndDate());
        }
