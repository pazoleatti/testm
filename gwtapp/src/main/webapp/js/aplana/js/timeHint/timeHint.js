 ...
 */
    .service('TimeHintService', [function () {
        ...
        this.init = function (scope, attrs) {
               ...
               /**TODO: в будущем стоит доработать JSON сериализатор, чтобы метод контроллера ReferenceController getLastActionDate возвращал данные в правильном формате**/
                var calcTime = function (offset, date) {
                    var d = angular.isDate(date) ? date : new Date(parseInt(date));
