(function () {
    ...
    angular.module('sbrfNdfl.ndfl', ['ui.router', 'sbrfNdfl.createOrEditFLDialog'])
        ...
        /**
         * @description Контроллер страницы РНУ НДФЛ
         */
        .controller('ndflCtrl', [
            ...
            function ($scope, $timeout, $state, $stateParams, dialogs, $showToDoDialog) {
                ...
                function setButtonsEnabled() {
                    ...
                    if ($scope.selectedItems) {
                        if ($scope.selectedItems.length === 0) {
                            ...
                            $scope.editReqsEnabled = $scope.selectedItems.length === 1;
                            $scope.deleteReqsEnabled = $scope.selectedItems.length > 0;
                        }
                    }
                ...
                /**
                 * @description Событие, которое возникает по нажатию на кнопку "Редактировать"
                 */
                ...
                $scope.createFLClick = function () {
                    ...
                    var dlg = dialogs.create('client/app/taxes/ndfl/createOrEditFlDialog.html', 'createOrEditFLCtrl', data, opts);
                ...
                /**
                 * @description Удаление ФЛ
                 */
                $scope.deleteFLClick = function () {
                    $showToDoDialog();
                };
                ...
                function initPage() {
                    ...
                    $scope.searchFilter.params.inn = undefined;
                    $scope.searchFilter.params.dateTo = undefined;
                    $scope.searchFilter.params.dateFrom = undefined;
                    $scope.editReqsEnabled = false;
                    $scope.deleteReqsEnabled = false;
                    setButtonsEnabled();
                }
