(function () {
    ...
    var translateDictionary = {
        ...
        "menu.taxes.application2": "Приложение 2",
        ...
        "header.application2Journal.forms": "НДФЛ - Приложение 2 к декларации по налогу на прибыль",
        ...
        "app2Journal.button.createApp2": "Создать Приложение 2",
        "app2Journal.button.downloadReport": "Выгрузить",
        "app2Journal.button.byFilter": "Отобранные по фильтру",
        "app2Journal.button.selected": "Выбранные на странице",
        "app2Journal.filter.periodType": "Тип периода",
        "app2Journal.filter.period": "Период",
        "app2Journal.filter.application2Number": "Номер формы",
        "app2Journal.filter.state": "Состояние",
        "app2Journal.filter.note": "Примечание",
        ...
        "title.app2Period.value": "{{year}}: {{periodName}}{{correctionString}}",
        ...
        "title.numberApplication2": "Номер формы",
        "title.inp": "ИНП",
        ...
        "title.taxRate2": "Налоговая ставка",
        ...
        "title.calculatedTax2": "Сумма налога исчисленная",
        "title.withholdingTax": "Удержанный",
        "title.withholdingTax2": "Сумма налога удержанная",
        "title.transferredTax": "Сумма налога перечисленная",
        "title.notHoldingTax": "Не удержанный",
        "title.notHoldingTax2": "Сумма налога неудержанная",
        "title.overholdingTax": "Излишне удержанный",
        "title.overholdingTax2": "Сумма налога излишне удержанная",
        ...
        "ndfl.notApp2DeclarationDataEnd": " не является отчетностью \"Приложение 2\". Вы будете перенаправлены на главную страницу",
        ...
        "reportPeriod.filter.formType": "Вид отчетности",
        "reportPeriod.grid.deadline": "Срок сдачи отчетности",
        "reportPeriod.grid.period": "Период",
        "reportPeriod.grid.formType": "Вид отчетности",
    ...
    var appModule = angular.module('app', [
        ...
        'app.ndflJournal',
        'app.ndflReport',
        'app.application2Report',
        'app.ndflReportJournal',
        'app.personsFor2NdflFL',
        'app.2ndflFLJournal',
        'app.application2Journal',
