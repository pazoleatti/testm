(function () {
    ...
    var translateDictionary = {
        ...
        "title.reopenPeriod": "Выбранный период закрыт. Выполнить переоткрытие?",
        ...
        "reportPersonFace.error.person": "Физическое лицо: ",
        "reportPersonFace.error.notFound": " не найдено в форме",
        "reportPersonFace.title.notCreated": "Отчет не сформирован",
        ...
        "reportPeriod.filter.searchEquals": "Искать по точному совпадению",
        "reportPeriod.dateReportPeriod": "Срок сдачи отчетности",
