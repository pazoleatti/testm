            ...
            return {
                ...
                link: function (scope, el, attrs, ngModel) {
                    ...
                    if (angular.isDefined(treeId)) {
                        ...
                        //if node head clicks,
                        treeRef.selectNodeHead = treeRef.selectNodeHead || function (selectedNode) {
                            //Collapse or Expand
                        ...
                        // Функция для выбора узла в дереве
                        treeRef._selectNode = treeRef._selectNode || function (selectedNode, $event, oldValue) {
                                if ((scope.multiSelect === 'true') || (scope.multiSelect === '')) {
                                    /**
                        ...
                        treeRef.selectNodeLabel = treeRef.selectNodeLabel || function (selectedNode, $event, oldValue) {
                                ...
                                if ((scope.treeDisabled === 'false') || (scope.treeDisabled === undefined)) {
                                    ...
                                    executeSelect.then(function (value) {
                                        if (value) {
                                            treeRef._selectNode(selectedNode, $event, oldValue);
                                        }
                                    });
                                }
                            };
                        ...
                        treeRef.setSelectedByProperty = treeRef.setSelectedByProperty || function (value, property) {
                                ...
                                if (selectedNode) {
                                    treeRef._selectNode(selectedNode, undefined, selectedNode.selected);
