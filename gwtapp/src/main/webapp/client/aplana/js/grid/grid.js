...
(function () {
    ...
    angular.module("aplana.grid", ['aplana.utils', 'aplana.webStorage'])
            ...
            var service = {
                ...
                resetSettings: function (grid, gridElement, initialConfig) {
                    ...
                    if (!!savedColOptions) {
                        ...
                        for (var idx = 0; idx < initialColIds.length; idx++) {
                            if (savedColIds.indexOf(initialColIds[idx]) !== -1) {
                                permutation.push(savedColIds.indexOf(initialColIds[idx]));
                            }
                        }
                    ...
                    //Восстанавливаем настройки сартировки и пагинации
                    var savedPageOptions = service.getPageSettings(gridName);
        ...
        .directive('aplanaGrid', ['$rootScope', '$gridStack', '$timeout', 'AplanaUtils', 'PagingBuilder', 'GridSettingsStorage', '$filter',
            function ($rootScope, $gridStack, $timeout, AplanaUtils, $pagingBuilder, GridSettingsStorage, $filter) {
                /**
                ...
                return {
                    ...
                    link: function (scope, element, attrs, ngModel) {
                        ...
                        scope.gridCtrl = {
                            ...
                            clickGroupNoTreeCheckbox: function(e) {
                                var currentCB = $(this);
                        ...
                        if (ngModel) {
                            ...
                            scope.gridCtrl.setRequired = function (value) {
                        ...
                        if (scope.gridOptions.grouping) {
                            ...
                            grid.on("change", ".groupHeader[type=checkbox]", function (e) {
                                var currentCB = $(this);
                                var isChecked = this.checked;
        ...
        .factory('$gridStack', [ '$$stackedMap', '$timeout', 'AplanaUtils', function ($$stackedMap, $timeout, AplanaUtils) {
            ...
            $gridStack.registerAdjustWidthGrid = function (_grid, _gridConfig, _enableAdjustWidthByColumns, _parentAdjustWidthCssSelector) {
                ...
                _gridConfig.resizeStop = function (newwidth, index) {
