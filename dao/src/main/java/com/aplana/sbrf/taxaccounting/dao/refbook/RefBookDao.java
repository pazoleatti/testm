...
public interface RefBookDao {
     ...
     * Записи ближайшей меньшей версии будут отмечены как удаленные на дату удаления <br>
     * Если дата удаления совпадает с версией записей, то записи будут полностью удалены.
     *
