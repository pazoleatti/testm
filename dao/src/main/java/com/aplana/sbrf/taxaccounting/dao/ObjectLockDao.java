...
public interface ObjectLockDao {
	 ...
	 * @throws com.aplana.sbrf.taxaccounting.model.exception.LockException если объект заблокирован другим пользователем и время блокировки еще не истекло.
	 */
	 ...
	 * @throws com.aplana.sbrf.taxaccounting.model.exception.LockException если объект не заблокирован, или заблокирован другим пользователем. Истёкшие по тайм-ауту блокировки, созданные
	 ...
	 * @throws com.aplana.sbrf.taxaccounting.model.exception.LockException если объект не заблокирован, данным пользователем
	 */
