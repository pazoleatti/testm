...
public class RaschsvSvSum1TipRowMapper implements RowMapper<RaschsvSvSum1Tip> {
    ...
    public RaschsvSvSum1Tip mapRow(ResultSet rs, int index) throws SQLException {
        ...
        raschsvSvSum1Tip.setSumVsegoPer(rs.getDouble(RaschsvSvSum1Tip.COL_SUM_VSEGO_PER));
        raschsvSvSum1Tip.setSumVsegoPosl3m(rs.getDouble(RaschsvSvSum1Tip.COL_SUM_VSEGO_POSL_3M));
        raschsvSvSum1Tip.setSum1mPosl3m(rs.getDouble(RaschsvSvSum1Tip.COL_SUM_1M_POSL_3M));
        raschsvSvSum1Tip.setSum2mPosl3m(rs.getDouble(RaschsvSvSum1Tip.COL_SUM_2M_POSL_3M));
        raschsvSvSum1Tip.setSum3mPosl3m(rs.getDouble(RaschsvSvSum1Tip.COL_SUM_3M_POSL_3M));
