...
public class SchedulerTaskDaoTest {
	...
	public void getAll() {
		...
		assertEquals(new GregorianCalendar(2013, Calendar.MARCH, 31).getTime(), tasks.get(0).getModificationDate().toDate());
		assertEquals(new GregorianCalendar(2015, Calendar.MARCH, 31).getTime(), tasks.get(0).getLast_fire_date().toDate());
