...
public class RefBookOracleTest {
    ...
    public void isVersionUsedInDepartmentConfigsTest() {
        ...
        assertTrue(result.contains("В настройке подразделения \"Байкальский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        ...
        assertTrue(result.contains("В настройке подразделения \"Волго-Вятский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        ...
        assertEquals(6, result.size());
        assertTrue(result.contains("В настройке подразделения \"Байкальский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Открытое акционерное общество \"Сбербанк России\"\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Волго-Вятский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Волго-Вятский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2016\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Среднерусский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Среднерусский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2016\" указана ссылка на версию!"));
        ...
        assertEquals(3, result.size());
        assertTrue(result.contains("В настройке подразделения \"Волго-Вятский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Открытое акционерное общество \"Сбербанк России\"\" для налог \"Учета контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
        assertTrue(result.contains("В настройке подразделения \"Среднерусский банк\" для налога \"Учет контролируемых сделок\" в периоде \"первый квартал 2015\" указана ссылка на версию!"));
