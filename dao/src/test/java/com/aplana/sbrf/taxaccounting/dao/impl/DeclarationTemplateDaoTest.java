...
public class DeclarationTemplateDaoTest {
    ...
    public void init() throws UnsupportedEncodingException {
        ...
        blobDataDao.createWithSysdate(blob);
    }

    @Test
    public void testListAll() {
        assertEquals(9, declarationTemplateDao.listAll().size());
    }
    ...
    public void testGetAll() {
        Assert.assertEquals(9, declarationTemplateDao.getByFilter(null).size());
    }
    ...
    public void testGetByFilter() {
        ...
        Assert.assertEquals(9, declarationTemplateDao.getByFilter(filter).size());
    }
