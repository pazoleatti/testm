...
INSERT INTO REF_BOOK_ATTRIBUTE (ID, REF_BOOK_ID, ORD, NAME, ALIAS, TYPE, REFERENCE_ID, ATTRIBUTE_ID, VISIBLE, PRECISION, WIDTH, IS_UNIQUE)
  VALUES (101, 30, 1, 'код подразделения', 'code', 2, null, null, 1, 5, 10, 1);
INSERT INTO REF_BOOK_ATTRIBUTE (ID, REF_BOOK_ID, ORD, NAME, ALIAS, TYPE, REFERENCE_ID, ATTRIBUTE_ID, VISIBLE, PRECISION, WIDTH, IS_UNIQUE)
  VALUES (162, 30, 2, 'Имя', 'name', 1, null, null, 1, null, 10, 1);
