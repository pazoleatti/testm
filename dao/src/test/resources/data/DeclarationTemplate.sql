...
insert into declaration_template(id, name, version, jrxml, declaration_type_id, status)
  values (2, 'Декларация 2', date '2014-01-01', null, 1, 1);
insert into declaration_template(id, name, version, jrxml, declaration_type_id, status)
  values (3, 'Декларация 3', date '2013-01-01', null, 2, 1);
insert into declaration_template(id, name, version, jrxml, declaration_type_id)
  values (4, 'Декларация 4', date '2013-01-01', null, 2);
insert into declaration_template(id, name, version, jrxml, declaration_type_id)
  values (5, 'Декларация 5', date '2014-01-01', null, 3);
insert into declaration_template(id, name, version, jrxml, declaration_type_id)
  values (6, 'Декларация 6', date '2014-12-31', null, 3);
