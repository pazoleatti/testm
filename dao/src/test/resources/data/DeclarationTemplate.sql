...
insert into declaration_template(id, edition, name, version, is_active, jrxml, declaration_type_id, status)
  values (1, 1, 'Декларация 1', date '2013-01-01' , 0, 'test-jrxml', 1, 0);
insert into declaration_template(id, edition, name, version, is_active, jrxml, declaration_type_id, status)
  values (2, 2, 'Декларация 2', date '2013-05-01', 1, 'test-jrxml', 1, 1);
insert into declaration_template(id, edition, name, version, is_active, jrxml, declaration_type_id, status)
...
insert into declaration_template(id, edition, name, version, is_active, jrxml, declaration_type_id)
  values (5, 1, 'Декларация 5', date '2014-01-01', 0, 'test-jrxml', 3);
insert into declaration_template(id, edition, name, version, is_active, jrxml, declaration_type_id)
  values (6, 1, 'Декларация 6', date '2014-12-31', 0, 'test-jrxml', 3);
