...
insert into form_template (id, type_id, data_rows, version, edition, fixed_rows, name, fullname, header)
  values (1, 1, null, date '2013-01-01', 1, 1,'name', 'fullname', 'header');
insert into form_template (id, type_id, data_rows, version, edition, fixed_rows, name, fullname, header)
  values (2, 2, null, date '2013-01-01', 1, 1,'name', 'fullname', 'header');
insert into form_template (id, type_id, data_rows, version, edition, fixed_rows, name, fullname, header)
  values (3, 3, null, date '2013-01-01', 1, 1,'name', 'fullname', 'header');
insert into form_template (id, type_id, data_rows, version, edition, fixed_rows, name, fullname, header)
  values (4, 4, null, date '2013-01-01', 1, 1,'name', 'fullname', 'header');
