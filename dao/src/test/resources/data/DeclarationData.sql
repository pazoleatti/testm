...
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values (3, 'Transport report period 1', 1, 23, date '2013-07-01', date '2013-09-30', date '2013-07-01');
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values (4, 'Transport report period 4', 1, 24, date '2013-10-01', date '2013-12-31', date '2013-10-01');
...
-- для проверки delete
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values (5, 'Transport report period 6', 1, 25, date '2013-01-01', date '2013-03-31', date '2013-01-01');
...
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values (6, 'Transport report period 5', 1, 26, date '2013-01-01', date '2013-03-31', date '2013-01-01');

-- для проверки setXmlData
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values (7, 'Transport report period 7', 1, 27, date '2013-01-01', date '2013-03-31', date '2013-01-01');
