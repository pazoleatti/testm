...
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id) values (2, 'Transport report period 3', 3, 1, 2, 21);
...
-- для проверки delete
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id) values (5, 'Transport report period 6', 3, 1, 5, 21);
...
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id) values (6, 'Transport report period 5', 3, 1, 6, 21);

-- для проверки setXmlData
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id) values (7, 'Transport report period 7', 3, 1, 7, 21);
