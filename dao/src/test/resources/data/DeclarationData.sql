insert into declaration_template(id, edition, version, is_active, declaration_type_id) values (1, 1, date '2014-01-01', 1, 1);
...
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (1, 'Transport report period 2', 3, 1, 1, 21, date '2013-01-01', date '2013-03-31');
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (2, 'Transport report period 3', 3, 1, 2, 22, date '2013-04-01', date '2013-06-30');
...
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (3, 'Transport report period 1', 3, 1, 3, 23, date '2013-07-01', date '2013-09-30');
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (4, 'Transport report period 4', 3, 1, 4, 24, date '2013-10-01', date '2013-12-31');
...
-- для проверки delete
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (5, 'Transport report period 6', 3, 1, 5, 25, date '2013-01-01', date '2013-03-31');
...
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (6, 'Transport report period 5', 3, 1, 6, 26, date '2013-01-01', date '2013-03-31');

-- для проверки setXmlData
insert into report_period (id, name, months, tax_period_id, ord, dict_tax_period_id, start_date, end_date) values (7, 'Transport report period 7', 3, 1, 7, 27, date '2013-01-01', date '2013-03-31');
