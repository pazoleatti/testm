...
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (1, 'Transport report period 2', 1, 3, 1, 1, 2);
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (2, 'Transport report period 3', 0, 3, 1, 2, 2);
...
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (3, 'Transport report period 1', 0, 3, 1, 3, 1);
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (4, 'Transport report period 4', 0, 3, 1, 4, 1);
...
-- для проверки delete
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (5, 'Transport report period 6', 0, 3, 1, 5, 5);
...
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (6, 'Transport report period 5', 0, 3, 1, 6, 5);

-- для проверки setXmlData
insert into report_period (id, name, is_active, months, tax_period_id, ord, department_id) values (7, 'Transport report period 7', 0, 3, 1, 7, 5);
