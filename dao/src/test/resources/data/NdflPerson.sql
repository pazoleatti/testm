...
insert into NDFL_PERSON (id, declaration_data_id, inp, FIRST_NAME, LAST_NAME, BIRTH_DAY, CITIZENSHIP, ID_DOC_TYPE, ID_DOC_NUMBER, STATUS, ROW_NUM) values
(201, 2, '100500', 'Ivan', 'Ivanov', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '001', '11', '0000', '1', 1),
(202, 2, 1234567890, 'Ivan', 'Ivanov', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 2),
(203, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 3),
(204, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 4),
(205, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 5),
(206, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 6),
(207, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 7),
(208, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 87),
(209, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 21),
(210, 2, 1234567890, 'Федор', 'Иванов', TO_DATE('01-01-1980', 'DD-MM-YYYY'), '123', '22', '0000', '2', 44);
