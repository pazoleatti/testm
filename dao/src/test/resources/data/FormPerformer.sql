...
insert into form_data (id, form_id, department_id, state, kind, report_period_id) values (1, 1, 1, 1, 2, 1);
insert into form_data (id, form_id, department_id, state, kind, report_period_id) values (2, 2, 2, 2, 3, 2);
