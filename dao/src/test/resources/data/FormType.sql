...
insert into form_type (id, name, tax_type, status, code) values (3, 'FormType - VAT', 'V', 0, 'code_3');
insert into form_type (id, name, tax_type, status, code) values (4, 'FormType - Property', 'P', 0, 'code_4');