...
insert into declaration_type (id, name) values (2, 'Вид налоговой формы 2');
insert into declaration_type (id, name) values (3, 'Вид налоговой формы 3');
...
insert into declaration_template(id, name, version, jrxml, declaration_type_id, status, form_kind, form_type)
  values (2, 'Налоговая форма 2', date '2013-05-01', null, 1, 1, 3, 2);
insert into declaration_template(id, name, version, jrxml, declaration_type_id, status, form_kind, form_type)
