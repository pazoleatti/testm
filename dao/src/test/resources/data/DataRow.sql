...
insert into data_row(id, form_data_id, alias, ord, type) values (4, 1000, 'R1{wan}', 4, 0);
insert into data_row(id, form_data_id, alias, ord, type) values (5, 1000, 'total2', 5, 0);