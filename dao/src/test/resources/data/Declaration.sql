...
insert into report_period (id, name, tax_type, is_active) values (1, 'Transport report period 1', 'T', 1)
insert into report_period (id, name, tax_type, is_active) values (2, 'Transport report period 2', 'T', 0)
...
insert into report_period (id, name, tax_type, is_active) values (3, 'Transport report period 3', 'T', 0)
insert into report_period (id, name, tax_type, is_active) values (4, 'Transport report period 4', 'T', 0)
...
-- для проверки delete
insert into report_period (id, name, tax_type, is_active) values (5, 'Transport report period 5', 'T', 0)
...
insert into report_period (id, name, tax_type, is_active) values (6, 'Transport report period 6', 'T', 0)

-- для проверки setXmlData
insert into report_period (id, name, tax_type, is_active) values (7, 'Transport report period 7', 'T', 0)
