...
values                      (1,   'Иванов',   'Борис',      'Петрович',   '1234', null,         null,       1,                date '1975-04-15',  null,         1,            1,        2,        1,          date '2016-01-01',  0,      1,          1,      null,       1,    1);
insert into ref_book_person (id,  last_name,  first_name,   middle_name,  inn,    inn_foreign,  snils,      taxpayer_state,   birth_date,         birth_place,  citizenship,  address,  employee, record_id,  version,            status, source_id,  old_id, old_status, vip,  report_doc)
values                      (2,   'Чучкалова','Екатерина',  'Викторовна', '2345', null,         null,       1,                date '1981-10-16',  null,         1,            2,        2,        2,          date '2016-01-01',  0,      2,          2,      null,       1,    3);
insert into ref_book_person (id,  last_name,  first_name,   middle_name,  inn,    inn_foreign,  snils,      taxpayer_state,   birth_date,         birth_place,  citizenship,  address,  employee, record_id,  version,            status, source_id,  old_id, old_status, vip,  report_doc)
...
insert into ref_book_person (id,  last_name,  first_name,   middle_name,  inn,    inn_foreign,  snils,      taxpayer_state,   birth_date,         birth_place,  citizenship,  address,  employee, record_id,  version,            status, source_id,  old_id, old_status, vip,  report_doc)
values                      (5,   'Doe',      'John',       null,         null,   'bb4',        null,       2,                date '1992-09-25',  null,         2,            5,        null,     5,          date '2016-01-01',  0,      6,          5,      null,       1,    null);
insert into ref_book_person (id,  last_name,  first_name,   middle_name,  inn,    inn_foreign,  snils,      taxpayer_state,   birth_date,         birth_place,  citizenship,  address,  employee, record_id,  version,            status, source_id,  old_id, old_status, vip,  report_doc)
values                      (6,   'Doe',      'Jane',       null,         null,   '123-d123',   null,       3,                date '1992-09-25',  null,         3,            6,        null,     6,          date '2016-01-01',  0,      6,          6,      null,       0,    null);
