...
insert into report_period (id, name, is_active, months, tax_period_id, ord) values (11, 'Transport report period 11', 0, 3, 10, 1);
insert into form_data(id, form_id, department_id, state, kind, report_period_id) values (11, 1, 1, 1, 3, 11);

insert into report_period (id, name, is_active, months, tax_period_id, ord) values (12, 'Transport report period 12', 0, 3, 10, 2);
