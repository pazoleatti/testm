...
insert into form_template (id, type_id, data_rows, version, is_active, edition, fixed_rows, name, fullname, header) values (1, 1, null, '0.1', 1, 1, 1, 'name', 'fullname', 'header');
...
insert into report_period (id, name, tax_period_id, dict_tax_period_id, start_date, end_date, calendar_start_date) values
(1, 'Transport report period 1', 1, 21, date '2013-01-01', date '2013-03-31', date '2013-01-01');
