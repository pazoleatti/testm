...
insert into form_column (id, name, form_id, ord, alias, type, width, precision, dictionary_code, group_name, max_length, checking)
	values (1, 'Строковый столбец', 1, 1, 'stringColumn', 'S', 10, null, null, null, 500, 1);

insert into form_column (id, name, form_id, ord, alias, type, width, precision, dictionary_code, group_name, checking)
