...
insert into form_template (id, type_id, data_rows, version, is_active, edition, fixed_rows, name, fullname, code, status) values (2, 2, null, date '2013-01-01', 0, 1, 0, 'name_2', 'fullname_2', 'code_2', 0);
insert into form_template (id, type_id, data_rows, version, is_active, edition, fixed_rows, name, fullname, code, status) values (3, 2, null, date '2013-02-01', 0, 1, 0, 'name_3', 'fullname_3', 'code_2', 1);
