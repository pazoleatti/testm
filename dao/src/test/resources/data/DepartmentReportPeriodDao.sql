...
insert into department_report_period(id, department_id, report_period_id, is_active, is_balance_period, correction_date, is_correct_period) values (1, 2, 1, 1, 0, to_date('01.01.2013', 'DD.MM.YY'), 0);
insert into department_report_period(id, department_id, report_period_id, is_active, is_balance_period, correction_date, is_correct_period) values (2, 2, 2, 0, 0, to_date('01.01.2013', 'DD.MM.YY'), 1);