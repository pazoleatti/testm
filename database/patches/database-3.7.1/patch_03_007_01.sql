...
begin 
	...
	if :v_cnt > 0 then
		dbms_output.put_line('Version 03.007.01 already installed.');
--		raise_application_error(-20999,'Version 03.007.01 already installed.');
	end if; 
end;
/  
...
@database-3.7.1/03_update_dml.sql

PROMPT ## 06_check_index_constraints
@database-3.7.1/06_check_index_constraints.sql
