package refbook // tb_person_ref комментарий для локального поиска скрипта
...
/**
 * Скрипт справочника Тербанки для ФЛ при первичной загрузке id = 907
 */
(new TbPerson(this)).run()

@TypeChecked
class TbPerson extends AbstractScriptClass {

    Map<String, RefBookValue> record
    DepartmentService departmentService

    @TypeChecked(TypeCheckingMode.SKIP)
    TbPerson(scriptClass) {
