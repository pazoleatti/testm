...
--REF_BOOK_REGION
---------------------------
ALTER TABLE REF_BOOK_REGION DROP CONSTRAINT CHK_REF_BOOK_REGION_OKTMO_DEF;

---------------------------
--Changed TABLE
--REF_BOOK_PERSON
---------------------------
ALTER TABLE REF_BOOK_PERSON DROP CONSTRAINT CHK_REF_BOOK_PERSON_EMPLOYEE;
ALTER TABLE REF_BOOK_PERSON DROP CONSTRAINT CHK_REF_BOOK_PERSON_MEDICAL;
ALTER TABLE REF_BOOK_PERSON DROP CONSTRAINT CHK_REF_BOOK_PERSON_PENSION;
ALTER TABLE REF_BOOK_PERSON DROP CONSTRAINT CHK_REF_BOOK_PERSON_SEX;
ALTER TABLE REF_BOOK_PERSON DROP CONSTRAINT CHK_REF_BOOK_PERSON_SOCIAL;

---------------------------
--Changed TABLE
--REF_BOOK_ID_DOC
---------------------------
ALTER TABLE REF_BOOK_ID_DOC DROP CONSTRAINT CHK_REF_BOOK_ID_DOC_REP;
...
--REF_BOOK_CALENDAR
---------------------------
ALTER TABLE REF_BOOK_CALENDAR DROP CONSTRAINT CHK_REF_BOOK_CAL_WORK;
ALTER TABLE REF_BOOK_CALENDAR ADD CONSTRAINT CHK_REF_BOOK_CAL_CTYPE CHECK (ctype in (0,1)) ENABLE;
...
--REF_BOOK_ADDRESS
---------------------------
ALTER TABLE REF_BOOK_ADDRESS DROP CONSTRAINT CHK_REF_BOOK_ADDRESS_ADDR_N_RF;
ALTER TABLE REF_BOOK_ADDRESS DROP CONSTRAINT CHK_REF_BOOK_ADDRESS_ADDR_RF;
...
---------------------------
  CREATE INDEX DECL_DATA_FILE_FK_DECL_DATA ON DECLARATION_DATA_FILE (DECLARATION_DATA_ID);
---------------------------
--New INDEX
--FORM_DATA_SOURCE_FK_DEP_ID
---------------------------
  CREATE INDEX FORM_DATA_SOURCE_FK_DEP_ID ON FORM_DATA_SOURCE (DEPARTMENT_FORM_TYPE_ID);
---------------------------
--New INDEX
--FORM_DATA_REP_FK_FORM_DATA_ID
---------------------------
  CREATE INDEX FORM_DATA_REP_FK_FORM_DATA_ID ON FORM_DATA_REPORT (FORM_DATA_ID);
---------------------------
--New INDEX
...
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_IT_425_SUM ON RASCHSV_VYPLAT_IT_425 (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--DECL_REPORT_FK_DECL_SUBREPORT
---------------------------
  CREATE INDEX DECL_REPORT_FK_DECL_SUBREPORT ON DECLARATION_REPORT (SUBREPORT_ID);
---------------------------
--New INDEX
--FK_RASCHSV_OPS_OMS_R_SUM_TIP
---------------------------
  CREATE INDEX FK_RASCHSV_OPS_OMS_R_SUM_TIP ON RASCHSV_OPS_OMS_RASCH_SUM (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--FK_RASCHSV_SV_INO_GRAZD_SUM
---------------------------
  CREATE INDEX FK_RASCHSV_SV_INO_GRAZD_SUM ON RASCHSV_SV_INO_GRAZD (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--DECL_SUBREP_FK_DECL_TEMPLATE
---------------------------
  CREATE INDEX DECL_SUBREP_FK_DECL_TEMPLATE ON DECLARATION_SUBREPORT (DECLARATION_TEMPLATE_ID);
---------------------------
--New INDEX
--DEPT_FORM_TYPE_PERF_FK_ID
---------------------------
  CREATE INDEX DEPT_FORM_TYPE_PERF_FK_ID ON DEPARTMENT_FORM_TYPE_PERFORMER (DEPARTMENT_FORM_TYPE_ID);
---------------------------
--New INDEX
--FK_DEPT_DECL_TYPE_PERF_ID
---------------------------
  CREATE INDEX FK_DEPT_DECL_TYPE_PERF_ID ON DEPARTMENT_DECL_TYPE_PERFORMER (DEPARTMENT_DECL_TYPE_ID);
---------------------------
--New INDEX
--DECL_REPORT_FK_DECL_DATA
---------------------------
  CREATE INDEX DECL_REPORT_FK_DECL_DATA ON DECLARATION_REPORT (DECLARATION_DATA_ID);
---------------------------
--New INDEX
...
---------------------------
  CREATE INDEX FK_RASCHSV_SVED_P_TARIF9_427 ON RASCHSV_SVED_PATENT (RASCHSV_SV_PRIM_TARIF9_427_ID);
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_KOL_TIP
---------------------------
  CREATE INDEX FK_RASCHSV_OSS_VNM_KOL_TIP ON RASCHSV_OSS_VNM_KOL (RASCHSV_KOL_LIC_TIP_ID);
---------------------------
--New INDEX
--FK_RASCHSV_SV_P_M_KOL_TIP
---------------------------
  CREATE INDEX FK_RASCHSV_SV_P_M_KOL_TIP ON RASCHSV_OPS_OMS_RASCH_KOL (RASCHSV_KOL_LIC_TIP_ID);
---------------------------
--New INDEX
...
---------------------------
  CREATE INDEX FK_PERS_SV_STRAH_FACE_DECLARAT ON RASCHSV_PERS_SV_STRAH_LIC (DECLARATION_DATA_ID);
---------------------------
--New INDEX
--NDFL_PD_FK_NP
---------------------------
  CREATE INDEX NDFL_PD_FK_NP ON NDFL_PERSON_DEDUCTION (NDFL_PERSON_ID);
---------------------------
--New INDEX
--FORM_DATA_REF_BOOK_FK_REFBOOK
---------------------------
  CREATE INDEX FORM_DATA_REF_BOOK_FK_REFBOOK ON FORM_DATA_REF_BOOK (REF_BOOK_ID);
---------------------------
--New INDEX
--IDX_FIAS_ADDROBJ_REG_LSTAT
---------------------------
  CREATE INDEX IDX_FIAS_ADDROBJ_REG_LSTAT ON FIAS_ADDROBJ (REGIONCODE,LIVESTATUS);
---------------------------
--New INDEX
--FORM_DATA_SOURCE_FK_SRC_DEP_ID
---------------------------
  CREATE INDEX FORM_DATA_SOURCE_FK_SRC_DEP_ID ON FORM_DATA_SOURCE (SRC_DEPARTMENT_FORM_TYPE_ID);
---------------------------
--New INDEX
--NDFL_PP_FK_NP
---------------------------
  CREATE INDEX NDFL_PP_FK_NP ON NDFL_PERSON_PREPAYMENT (NDFL_PERSON_ID);
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF3_422
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_TARIF3_422 ON RASCHSV_VYPLAT_IT_422 (RASCHSV_SV_PRIM_TARIF1_422_ID);
---------------------------
--New INDEX
--REF_BOOK_VALUE_FK_RECORD_ID
---------------------------
  CREATE INDEX REF_BOOK_VALUE_FK_RECORD_ID ON REF_BOOK_VALUE (RECORD_ID);
---------------------------
--Changed INDEX
...
---------------------------
  CREATE INDEX FK_RASCHSV_OSS_VNM_KOL_OSS ON RASCHSV_OSS_VNM_KOL (RASCHSV_OSS_VNM_ID);
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF2_425
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_TARIF2_425 ON RASCHSV_VYPLAT_IT_425 (RASCHSV_SV_PRIM_TARIF2_425_ID);
---------------------------
--New INDEX
--LOCK_DATA_SUBSCR_FK_SEC_USER
---------------------------
  CREATE INDEX LOCK_DATA_SUBSCR_FK_SEC_USER ON LOCK_DATA_SUBSCRIBERS (USER_ID);
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF9_427
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_TARIF9_427 ON RASCHSV_VYPLAT_IT_427 (RASCHSV_SV_PRIM_TARIF9_427_ID);
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_IT_427_SUM
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_IT_427_SUM ON RASCHSV_VYPLAT_IT_427 (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--FORM_DATA_REF_BOOK_FK_FORMDATA
---------------------------
  CREATE INDEX FORM_DATA_REF_BOOK_FK_FORMDATA ON FORM_DATA_REF_BOOK (FORM_DATA_ID);
---------------------------
--New INDEX
--DECL_SOURCE_FK_DEPT_FORMTYPE
---------------------------
  CREATE INDEX DECL_SOURCE_FK_DEPT_FORMTYPE ON DECLARATION_SOURCE (SRC_DEPARTMENT_FORM_TYPE_ID);
---------------------------
--New INDEX
--FK_RASCHSV_I_GRAZD_TARIF2_425
---------------------------
  CREATE INDEX FK_RASCHSV_I_GRAZD_TARIF2_425 ON RASCHSV_SV_INO_GRAZD (RASCHSV_SV_PRIM_TARIF2_425_ID);
---------------------------
--New INDEX
--NDFL_PERSON_FK_D
---------------------------
  CREATE INDEX NDFL_PERSON_FK_D ON NDFL_PERSON (DECLARATION_DATA_ID);
---------------------------
--New INDEX
--DECL_SOURCE_FK_DEPT_DECLTYPE
---------------------------
  CREATE INDEX DECL_SOURCE_FK_DEPT_DECLTYPE ON DECLARATION_SOURCE (DEPARTMENT_DECLARATION_TYPE_ID);
---------------------------
--New INDEX
--FK_RASCHSV_SVED_PATENT_SUM
---------------------------
  CREATE INDEX FK_RASCHSV_SVED_PATENT_SUM ON RASCHSV_SVED_PATENT (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_SUM_OSS
---------------------------
  CREATE INDEX FK_RASCHSV_OSS_VNM_SUM_OSS ON RASCHSV_OSS_VNM_SUM (RASCHSV_OSS_VNM_ID);
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_SUM_TIP
---------------------------
  CREATE INDEX FK_RASCHSV_OSS_VNM_SUM_TIP ON RASCHSV_OSS_VNM_SUM (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
--New INDEX
--FORM_DATA_FILE_FK_FORM_DATA
---------------------------
  CREATE INDEX FORM_DATA_FILE_FK_FORM_DATA ON FORM_DATA_FILE (FORM_DATA_ID);
---------------------------
--New INDEX
--CONFIGURATION_FK
---------------------------
  CREATE INDEX CONFIGURATION_FK ON CONFIGURATION (DEPARTMENT_ID);
---------------------------
--New INDEX
--FK_RASCHSV_SV_OPS_OMS_KOL
---------------------------
  CREATE INDEX FK_RASCHSV_SV_OPS_OMS_KOL ON RASCHSV_OPS_OMS_RASCH_KOL (RASCHSV_OPS_OMS_RASCH_KOL_ID);
---------------------------
--New INDEX
--FK_RASCHSV_SV_OPS_OMS_SUM
---------------------------
  CREATE INDEX FK_RASCHSV_SV_OPS_OMS_SUM ON RASCHSV_OPS_OMS_RASCH_SUM (RASCHSV_OPS_OMS_RASCH_SUM_ID);
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_IT_422_SUM
---------------------------
  CREATE INDEX FK_RASCHSV_VYPLAT_IT_422_SUM ON RASCHSV_VYPLAT_IT_422 (RASCHSV_SV_SUM1_TIP_ID);
---------------------------
