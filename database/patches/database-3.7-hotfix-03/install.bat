...
IF EXIST _log\patch_03_007_hotfix_01.log DEL /s /q /f _log\patch_03_007_hotfix_01.log
...
"%ORA_BIN%\sqlplus" %DBA_AUTH% @"patch_03_007_hotfix_03.sql" %NDFL_USR% _log/patch_03_007_hotfix_03.log %ORA_BIN% %DBA_AUTH% 
