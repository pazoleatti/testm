...
class Import extends AbstractScriptClass {
    ...
    final String REFOUND_TAX = "НДФЛ возвращенный НП"
    final String TAX_TRANSFER_DATE = "Срок перечисления в бюджет"
    final String PAYMENT_DATE = "Дата платежного поручения"
    final String PAYMENT_NUMBER = "Номер платежного поручения"
    final String TAX_SUMM = "Сумма платежного поручения"
