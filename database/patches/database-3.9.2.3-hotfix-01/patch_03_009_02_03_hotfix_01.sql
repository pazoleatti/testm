...
begin 
	...
	if :v_cnt = 0 then
  	...
  	select count(1) into :v_cnt from version_history where status='OK' and version='03.009.02.fx.03';
	if :v_cnt > 0 then
		dbms_output.put_line('Hotfix 03.009.02.hotfix.03 already installed.');
	end if; 
end;
/  
