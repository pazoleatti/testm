INSERT INTO declaration_subreport (id,declaration_template_id,name,ord,alias,blob_data_id,select_record) VALUES 
	(2001,200,'Сведения о ФЛ c параметрами',4,'person_rep_param','e88efec4-f3ab-4162-a36a-053b2004b14e',1);
INSERT INTO declaration_subreport (id,declaration_template_id,name,ord,alias,blob_data_id,select_record) VALUES 
	(2002,200,'Сводный отчет',3,'consolidated_report','3784d4da-a6f9-41c1-aec5-932d58bc2da6',0);	
