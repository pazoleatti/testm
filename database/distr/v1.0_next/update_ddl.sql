...
---------------------------
COMMENT ON COLUMN "NDFL_NEXT"."REF_BOOK_TARIFF_PAYER"."FOR_OPS_DOP" IS 'Используется для доп. тарифов ОПС';

---------------------------
--Changed TABLE
--REF_BOOK_REGION
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_REGION" DROP CONSTRAINT "CHK_REF_BOOK_REGION_OKTMO_DEF";

---------------------------
--Changed TABLE
--REF_BOOK_PERSON
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_PERSON" DROP CONSTRAINT "CHK_REF_BOOK_PERSON_EMPLOYEE";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_PERSON" DROP CONSTRAINT "CHK_REF_BOOK_PERSON_MEDICAL";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_PERSON" DROP CONSTRAINT "CHK_REF_BOOK_PERSON_PENSION";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_PERSON" DROP CONSTRAINT "CHK_REF_BOOK_PERSON_SEX";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_PERSON" DROP CONSTRAINT "CHK_REF_BOOK_PERSON_SOCIAL";

---------------------------
--Changed TABLE
--REF_BOOK_ID_DOC
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_ID_DOC" DROP CONSTRAINT "CHK_REF_BOOK_ID_DOC_REP";

---------------------------
--Changed TABLE
--REF_BOOK_FORM_TYPE
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_FORM_TYPE" MODIFY CONSTRAINT "CHK_REF_BOOK_FORM_TYPE_TAXKIND" ENABLE;

---------------------------
--Changed TABLE
--REF_BOOK_CALENDAR
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_CALENDAR" DROP CONSTRAINT "CHK_REF_BOOK_CAL_WORK";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_CALENDAR" ADD CONSTRAINT "CHK_REF_BOOK_CAL_CTYPE" CHECK (ctype in (0,1)) ENABLE;
COMMENT ON COLUMN "NDFL_NEXT"."REF_BOOK_CALENDAR"."CTYPE" IS 'Рабочий/Выходной (0 - рабочий, 1 - выходной)';

---------------------------
--Changed TABLE
--REF_BOOK_ADDRESS
---------------------------
ALTER TABLE "NDFL_NEXT"."REF_BOOK_ADDRESS" DROP CONSTRAINT "CHK_REF_BOOK_ADDRESS_ADDR_N_RF";
ALTER TABLE "NDFL_NEXT"."REF_BOOK_ADDRESS" DROP CONSTRAINT "CHK_REF_BOOK_ADDRESS_ADDR_RF";

---------------------------
--Changed TABLE
--NDFL_PERSON_PREPAYMENT
---------------------------
ALTER TABLE "NDFL_NEXT"."NDFL_PERSON_PREPAYMENT" DROP CONSTRAINT "NDFL_PP_FK_S";
ALTER TABLE "NDFL_NEXT"."NDFL_PERSON_PREPAYMENT" ADD CONSTRAINT "NDFL_PP_FK_S" FOREIGN KEY ("SOURCE_ID") REFERENCES "NDFL_NEXT"."NDFL_PERSON_PREPAYMENT"("ID") ON DELETE SET NULL ENABLE;

---------------------------
--Changed TABLE
--NDFL_PERSON_DEDUCTION
---------------------------
ALTER TABLE "NDFL_NEXT"."NDFL_PERSON_DEDUCTION" DROP CONSTRAINT "NDFL_PD_FK_S";
ALTER TABLE "NDFL_NEXT"."NDFL_PERSON_DEDUCTION" ADD CONSTRAINT "NDFL_PD_FK_S" FOREIGN KEY ("SOURCE_ID") REFERENCES "NDFL_NEXT"."NDFL_PERSON_DEDUCTION"("ID") ON DELETE SET NULL ENABLE;

---------------------------
--New INDEX
--DECL_DATA_FILE_FK_DECL_DATA
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_DATA_FILE_FK_DECL_DATA" ON "NDFL_NEXT"."DECLARATION_DATA_FILE" ("DECLARATION_DATA_ID");
---------------------------
--New INDEX
--FORM_DATA_SOURCE_FK_DEP_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_SOURCE_FK_DEP_ID" ON "NDFL_NEXT"."FORM_DATA_SOURCE" ("DEPARTMENT_FORM_TYPE_ID");
---------------------------
--New INDEX
--FORM_DATA_REP_FK_FORM_DATA_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_REP_FK_FORM_DATA_ID" ON "NDFL_NEXT"."FORM_DATA_REPORT" ("FORM_DATA_ID");
---------------------------
--New INDEX
--SRCH_FSOCRBASE_LEV_SCNAME_N
---------------------------
  CREATE INDEX "NDFL_NEXT"."SRCH_FSOCRBASE_LEV_SCNAME_N" ON "NDFL_NEXT"."FIAS_SOCRBASE" ("LEV",TRIM(LOWER("SCNAME"||'.')));
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_IT_425_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_IT_425_SUM" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_425" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--DECL_REPORT_FK_DECL_SUBREPORT
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_REPORT_FK_DECL_SUBREPORT" ON "NDFL_NEXT"."DECLARATION_REPORT" ("SUBREPORT_ID");
---------------------------
--New INDEX
--FK_RASCHSV_OPS_OMS_R_SUM_TIP
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_OPS_OMS_R_SUM_TIP" ON "NDFL_NEXT"."RASCHSV_OPS_OMS_RASCH_SUM" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--FK_RASCHSV_SV_INO_GRAZD_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SV_INO_GRAZD_SUM" ON "NDFL_NEXT"."RASCHSV_SV_INO_GRAZD" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--DECL_SUBREP_FK_DECL_TEMPLATE
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_SUBREP_FK_DECL_TEMPLATE" ON "NDFL_NEXT"."DECLARATION_SUBREPORT" ("DECLARATION_TEMPLATE_ID");
---------------------------
--New INDEX
--DEPT_FORM_TYPE_PERF_FK_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."DEPT_FORM_TYPE_PERF_FK_ID" ON "NDFL_NEXT"."DEPARTMENT_FORM_TYPE_PERFORMER" ("DEPARTMENT_FORM_TYPE_ID");
---------------------------
--New INDEX
--FK_DEPT_DECL_TYPE_PERF_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_DEPT_DECL_TYPE_PERF_ID" ON "NDFL_NEXT"."DEPARTMENT_DECL_TYPE_PERFORMER" ("DEPARTMENT_DECL_TYPE_ID");
---------------------------
--New INDEX
--DECL_REPORT_FK_DECL_DATA
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_REPORT_FK_DECL_DATA" ON "NDFL_NEXT"."DECLARATION_REPORT" ("DECLARATION_DATA_ID");
---------------------------
--New INDEX
--SRCH_FSOCRBASE_LEV_SCNAME
---------------------------
  CREATE INDEX "NDFL_NEXT"."SRCH_FSOCRBASE_LEV_SCNAME" ON "NDFL_NEXT"."FIAS_SOCRBASE" ("LEV",TRIM(LOWER("SCNAME")));
---------------------------
--New INDEX
--FK_RASCHSV_SVED_P_TARIF9_427
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SVED_P_TARIF9_427" ON "NDFL_NEXT"."RASCHSV_SVED_PATENT" ("RASCHSV_SV_PRIM_TARIF9_427_ID");
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_KOL_TIP
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_OSS_VNM_KOL_TIP" ON "NDFL_NEXT"."RASCHSV_OSS_VNM_KOL" ("RASCHSV_KOL_LIC_TIP_ID");
---------------------------
--New INDEX
--FK_RASCHSV_SV_P_M_KOL_TIP
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SV_P_M_KOL_TIP" ON "NDFL_NEXT"."RASCHSV_OPS_OMS_RASCH_KOL" ("RASCHSV_KOL_LIC_TIP_ID");
---------------------------
--New INDEX
--I_DECL_DATA_CONSOLIDATION_UNQ
---------------------------
  CREATE UNIQUE INDEX "NDFL_NEXT"."I_DECL_DATA_CONSOLIDATION_UNQ" ON "NDFL_NEXT"."DECLARATION_DATA_CONSOLIDATION" (CASE  WHEN "SOURCE_DECLARATION_DATA_ID" IS NOT NULL THEN "TARGET_DECLARATION_DATA_ID" END ,"SOURCE_DECLARATION_DATA_ID");
---------------------------
--New INDEX
--FK_PERS_SV_STRAH_FACE_DECLARAT
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_PERS_SV_STRAH_FACE_DECLARAT" ON "NDFL_NEXT"."RASCHSV_PERS_SV_STRAH_LIC" ("DECLARATION_DATA_ID");
---------------------------
--New INDEX
--NDFL_PD_FK_NP
---------------------------
  CREATE INDEX "NDFL_NEXT"."NDFL_PD_FK_NP" ON "NDFL_NEXT"."NDFL_PERSON_DEDUCTION" ("NDFL_PERSON_ID");
---------------------------
--New INDEX
--FORM_DATA_REF_BOOK_FK_REFBOOK
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_REF_BOOK_FK_REFBOOK" ON "NDFL_NEXT"."FORM_DATA_REF_BOOK" ("REF_BOOK_ID");
---------------------------
--New INDEX
--IDX_FIAS_ADDROBJ_REG_LSTAT
---------------------------
  CREATE INDEX "NDFL_NEXT"."IDX_FIAS_ADDROBJ_REG_LSTAT" ON "NDFL_NEXT"."FIAS_ADDROBJ" ("REGIONCODE","LIVESTATUS");
---------------------------
--New INDEX
--FORM_DATA_SOURCE_FK_SRC_DEP_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_SOURCE_FK_SRC_DEP_ID" ON "NDFL_NEXT"."FORM_DATA_SOURCE" ("SRC_DEPARTMENT_FORM_TYPE_ID");
---------------------------
--New INDEX
--NDFL_PP_FK_NP
---------------------------
  CREATE INDEX "NDFL_NEXT"."NDFL_PP_FK_NP" ON "NDFL_NEXT"."NDFL_PERSON_PREPAYMENT" ("NDFL_PERSON_ID");
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF3_422
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_TARIF3_422" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_422" ("RASCHSV_SV_PRIM_TARIF1_422_ID");
---------------------------
--New INDEX
--REF_BOOK_VALUE_FK_RECORD_ID
---------------------------
  CREATE INDEX "NDFL_NEXT"."REF_BOOK_VALUE_FK_RECORD_ID" ON "NDFL_NEXT"."REF_BOOK_VALUE" ("RECORD_ID");
---------------------------
--Changed INDEX
--IDX_FIAS_SOCRBASE_LEV
---------------------------
DROP INDEX "NDFL_NEXT"."IDX_FIAS_SOCRBASE_LEV";
  CREATE INDEX "NDFL_NEXT"."IDX_FIAS_SOCRBASE_LEV" ON "NDFL_NEXT"."FIAS_SOCRBASE" ("LEV",INSTR("SCNAME",'.'));
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_KOL_OSS
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_OSS_VNM_KOL_OSS" ON "NDFL_NEXT"."RASCHSV_OSS_VNM_KOL" ("RASCHSV_OSS_VNM_ID");
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF2_425
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_TARIF2_425" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_425" ("RASCHSV_SV_PRIM_TARIF2_425_ID");
---------------------------
--New INDEX
--LOCK_DATA_SUBSCR_FK_SEC_USER
---------------------------
  CREATE INDEX "NDFL_NEXT"."LOCK_DATA_SUBSCR_FK_SEC_USER" ON "NDFL_NEXT"."LOCK_DATA_SUBSCRIBERS" ("USER_ID");
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_TARIF9_427
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_TARIF9_427" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_427" ("RASCHSV_SV_PRIM_TARIF9_427_ID");
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_IT_427_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_IT_427_SUM" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_427" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--FORM_DATA_REF_BOOK_FK_FORMDATA
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_REF_BOOK_FK_FORMDATA" ON "NDFL_NEXT"."FORM_DATA_REF_BOOK" ("FORM_DATA_ID");
---------------------------
--New INDEX
--DECL_SOURCE_FK_DEPT_FORMTYPE
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_SOURCE_FK_DEPT_FORMTYPE" ON "NDFL_NEXT"."DECLARATION_SOURCE" ("SRC_DEPARTMENT_FORM_TYPE_ID");
---------------------------
--New INDEX
--FK_RASCHSV_I_GRAZD_TARIF2_425
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_I_GRAZD_TARIF2_425" ON "NDFL_NEXT"."RASCHSV_SV_INO_GRAZD" ("RASCHSV_SV_PRIM_TARIF2_425_ID");
---------------------------
--New INDEX
--NDFL_PERSON_FK_D
---------------------------
  CREATE INDEX "NDFL_NEXT"."NDFL_PERSON_FK_D" ON "NDFL_NEXT"."NDFL_PERSON" ("DECLARATION_DATA_ID");
---------------------------
--New INDEX
--DECL_SOURCE_FK_DEPT_DECLTYPE
---------------------------
  CREATE INDEX "NDFL_NEXT"."DECL_SOURCE_FK_DEPT_DECLTYPE" ON "NDFL_NEXT"."DECLARATION_SOURCE" ("DEPARTMENT_DECLARATION_TYPE_ID");
---------------------------
--New INDEX
--FK_RASCHSV_SVED_PATENT_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SVED_PATENT_SUM" ON "NDFL_NEXT"."RASCHSV_SVED_PATENT" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_SUM_OSS
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_OSS_VNM_SUM_OSS" ON "NDFL_NEXT"."RASCHSV_OSS_VNM_SUM" ("RASCHSV_OSS_VNM_ID");
---------------------------
--New INDEX
--FK_RASCHSV_OSS_VNM_SUM_TIP
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_OSS_VNM_SUM_TIP" ON "NDFL_NEXT"."RASCHSV_OSS_VNM_SUM" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--New INDEX
--FORM_DATA_FILE_FK_FORM_DATA
---------------------------
  CREATE INDEX "NDFL_NEXT"."FORM_DATA_FILE_FK_FORM_DATA" ON "NDFL_NEXT"."FORM_DATA_FILE" ("FORM_DATA_ID");
---------------------------
--New INDEX
--CONFIGURATION_FK
---------------------------
  CREATE INDEX "NDFL_NEXT"."CONFIGURATION_FK" ON "NDFL_NEXT"."CONFIGURATION" ("DEPARTMENT_ID");
---------------------------
--New INDEX
--FK_RASCHSV_SV_OPS_OMS_KOL
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SV_OPS_OMS_KOL" ON "NDFL_NEXT"."RASCHSV_OPS_OMS_RASCH_KOL" ("RASCHSV_OPS_OMS_RASCH_KOL_ID");
---------------------------
--New INDEX
--FK_RASCHSV_SV_OPS_OMS_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_SV_OPS_OMS_SUM" ON "NDFL_NEXT"."RASCHSV_OPS_OMS_RASCH_SUM" ("RASCHSV_OPS_OMS_RASCH_SUM_ID");
---------------------------
--New INDEX
--FK_RASCHSV_VYPLAT_IT_422_SUM
---------------------------
  CREATE INDEX "NDFL_NEXT"."FK_RASCHSV_VYPLAT_IT_422_SUM" ON "NDFL_NEXT"."RASCHSV_VYPLAT_IT_422" ("RASCHSV_SV_SUM1_TIP_ID");
---------------------------
--Changed PACKAGE BODY
--FIAS_PKG
---------------------------
CREATE OR REPLACE PACKAGE BODY "NDFL_NEXT"."FIAS_PKG" as
