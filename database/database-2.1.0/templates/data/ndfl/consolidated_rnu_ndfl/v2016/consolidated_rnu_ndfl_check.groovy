        ...
        for (NdflPerson ndflPerson : ndflPersonList) {
            ...
            if (ndflPerson.personId == null || ndflPerson.personId == 0) {
                ...
                if (!personRecord) {
                    ...
                    if (ndflPerson.birthDay != null && !ndflPerson.birthDay.equals(new LocalDateTime(personRecord.get(RF_BIRTH_DATE).getDateValue()))) {
                        String pathError = String.format(SECTION_LINE_MSG, T_PERSON, ndflPerson.rowNum ?: "")
 ...
 */
    Map<String, List<String>> getRefBookNdflDetail(def departmentParamId) {
        ...
        departmentParamTableList.each { Map<String, RefBookValue> departmentParamTable ->
