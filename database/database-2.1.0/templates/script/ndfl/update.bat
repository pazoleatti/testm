...
"%ORA_BIN%\sqlldr" userid=%AUTH% control="%BASE_DIR%/template_script.ldr" log="%LOG_DIR_REL%/%PREFIX%_7_template_script.txt" bad="%BAD_DIR_REL%/%PREFIX%_template_script.txt"
CD %BASE_DIR%
ECHO -- template_file
