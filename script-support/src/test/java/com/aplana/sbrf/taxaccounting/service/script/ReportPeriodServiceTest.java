...
public class ReportPeriodServiceTest {
	...
	public void init(){
		...
		ReportPeriod reportPeriod1 = getReportPeriod(1, taxPeriod1, 1);
		// подготовим модели reportPeriod
        ...
        ReportPeriod reportPeriod5 = getReportPeriod(5, taxPeriod2, 1);
        // отчетный период для 1 налогового периода по транспотру
        ReportPeriod reportPeriod4 = getReportPeriod(4, taxPeriod1, 4);
	 ...
	 */
	private ReportPeriod getReportPeriod(int id, TaxPeriod taxPeriod, int order){
