...
import com.aplana.sbrf.taxaccounting.async.task.CsvAuditGeneratorAsyncTask;
...
public class CsvAuditGeneratorAsyncTaskImpl extends CsvAuditGeneratorAsyncTask {
}