...
import com.aplana.sbrf.taxaccounting.async.task.ConsolidateFormDataAsyncTask;
...
public class ConsolidateFormDataAsyncTaskImpl extends ConsolidateFormDataAsyncTask {
}