...
import com.aplana.sbrf.taxaccounting.async.task.AcceptDeclarationAsyncTask;
...
public class AcceptDeclarationAsyncTaskImpl extends AcceptDeclarationAsyncTask {
}
