    ...
    angular.module('sbrfNdfl.productionPlanning', ['ui.router'])
        ...
        .controller('planningCtrl', [
            ...
            function ($scope, $timeout, aplanaEntityUtils, $state, aplanaDialogs) {
                ...
                function initPage() {
                    //Инициализация грида
                    aplanaEntityUtils.initGrid($scope, fetchData);
