 ...
 */
    ...
    .constant('dateTimePickerConfigValidation', function (configuration) {
        ...
        var validOptions = ['startView', 'minView', 'minuteStep', 'dropdownSelector', 'weekStart', 'utc', 'withSaveTime'];
    ...
    .directive('datetimepicker', ['dateTimePickerConfig', 'dateTimePickerConfigValidation', 'AplanaUtils', '$timeout', 'dateTimePickerModifyNgModel', '$dateParser',
        function (defaultConfig, validateConfigurationFunction, AplanaUtils, $timeout, dateTimePickerModifyNgModel, $dateParser) {
            "use strict";
        ...
        return {
            ...
            compile: function (element, attr) {
                ...
                if (attr.aplanaDatetimepicker === "date") {
                    dateTimeElement.attr("data-datetimepicker-config", "{ startView: \\'day\\', minView: \\'day\\', utc: true, withSaveTime: false }");
