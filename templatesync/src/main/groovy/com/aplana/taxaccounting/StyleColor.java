...
/**
 * Enum, представляющий цвета (копия StyleColor)
 * 
...
public enum StyleColor {
	 ...
	 * Светло-красный
	 */
    LIGHT_CORAL(8, 240, 128, 128, "#F08080 Светло-красный"),
	/**
	 * Светло-оранжевый
	 */
     ...
     * Светло-зеленый
     */
    PALE_GREEN(12, 152, 251, 152, "#98FB98 Светло-зеленый"),
    /**
     * Темно-зеленый
     */
    DARK_GREEN(13, 0, 108, 0, "#006C00 Темно-зеленый");

	private StyleColor(int id, int red, int green, int blue, String title) {
		this.id = id;
		this.red = red;
		this.green = green;
		this.blue = blue;
	 ...
	 * @return объект StyleColor, имеющий заданный идентификатор
	 * @throws IllegalArgumentException если передан идентификатор, для которого не задан цвет
	 */
	public static StyleColor getById(int id) {
		for (StyleColor c: values()) {
			if (c.id == id) {
				return c;
			}
		}
		throw new IllegalArgumentException("Wrong StyleColor id: " + id);
	}
}
