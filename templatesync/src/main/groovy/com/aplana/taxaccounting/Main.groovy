...
class Main {
    ...
    def static TEMPLATE_NAME_TO_TYPE_ID = [
            ...
            'transport': [
                    ...
                    'declaration'     : -1,  // Декларация по транспортному налогу
                    'declaration_1'   : -31, // Декларация по транспортному налогу 5.03
            ...
            'market' : [
                    ...
                    'letter_of_credit': 913, // Данные по непокрытым аккредитивам
                    'market_2_1'      : 909, // 2.1 (Ежемесячный) Реестр выданных Банком гарантий (контргарантий, поручительств)
                    'market_2_6'      : 900, // 2.6 (Ежемесячный) Отчет о состоянии кредитного портфеля
                    'market_5_2a'     : 911, // 5.2(а) Отчет о выданных Банком инструментах торгового финансирования
                    'market_7_129'    : 905, // 7.129 (Ежемесячный) Кредитные договоры в CRM
                    'mis'             : 901, // Данные MIS
                    'summary_2_1'     : 910, // 2.1 (Сводный) Реестр выданных Банком гарантий (контргарантий, поручительств)
                    'summary_2_6'     : 904, // 2.6 (Сводный) Отчет о состоянии кредитного портфеля
                    'summary_5_2'     : 907, // 5.2 Отчет о выданных Банком кредитах
                    'summary_5_2b'    : 915, // 5.2(б) Отчет о выданных Банком гарантиях, аккредитивах и ИТФ
                    'summary_5_3_2'   : 908, // 5.3.2 Внутренние интервалы процентных ставок по Кредитным продуктам и Субординированным кредитам
                    'summary_5_5'     : 914, // 5.5 Внутренние интервалы плат по гарантиям и непокрытым аккредитивам, ИТФ
                    'summary_7_129'   : 906, // 7.129 (Сводный) Кредитные договоры в CRM
            ],
            'land' : [
                    'calc_for_declaration'   : 918, // Расчет земельного налога по земельным участкам, подлежащим включению в декларацию
                    'calc_tax_period'        : 916, // Расчет земельного налога за отчетные периоды
                    'declaration'            : -30, // Налоговая декларация по земельному налогу
                    'include_in_declaration' : 917, // Земельные участки, подлежащие включению в декларацию
                    'land_registry'          : 912, // Реестр земельных участков
            ]
    ]
